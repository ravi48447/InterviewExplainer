...
COMMENT ON TABLE question_internal_links IS 'Auto-generated SEO internal links between questions via concept overlap';
COMMENT ON TABLE keywords IS 'Keyword dictionary for StackOverflow-style auto-linking within content';
COMMENT ON TABLE question_keywords IS 'Maps questions to keywords for auto-linking engine';
COMMENT ON TABLE user_bookmarks IS 'User saved/bookmarked questions';
COMMENT ON TABLE user_progress IS 'Tracks which questions a user has completed';
