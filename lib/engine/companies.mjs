...
// ---------------- vetted profiles (public-source provenance) ----------------
// A small set of companies whose loops are grounded in OFFICIAL public
// guidance (careers sites, engineering blogs). These surface a "vetted"
// badge + source + review date in the UI; every other company remains an
// honest archetype practice loop.
// Sources checked 2026-09: each company's public careers/interview guidance.

export const VETTED = {
  amazon: {
    confidence: 'high',
    source: 'https://amazon.jobs/content/en/how-we-hire/interview-loop',
    sourceLabel: 'amazon.jobs — official interview-loop guidance',
    reviewedAt: '2026-09-01',
    evidence: 'Amazon\'s own guidance describes a multi-round loop tied to Leadership Principles, behavioral (STAR) questions, and a bar-raiser round.',
  },
  google: {
    confidence: 'high',
    source: 'https://www.techinterviewhandbook.org/interview-questions-google/',
    sourceLabel: 'aggregated public reports + Google careers',
    reviewedAt: '2026-09-01',
    evidence: 'DSA-first structure (coding rounds dominate), collaborative problem-solving, and "Googleyness" behavioral round are consistently documented across public candidate reports.',
  },
  microsoft: {
    confidence: 'medium',
    source: 'https://careers.microsoft.com/',
    sourceLabel: 'Microsoft careers + public candidate reports',
    reviewedAt: '2026-09-01',
    evidence: 'Calmer pace with CS-fundamentals depth and a final "As Appropriate" (AA) round; structure consistent with public reports.',
  },
  meta: {
    confidence: 'medium',
    source: 'https://www.meta.com/careers/',
    sourceLabel: 'Meta careers + public candidate reports',
    reviewedAt: '2026-09-01',
    evidence: 'Two-problems-per-coding-round pace and behavioral ("Daring") round; consistent across public candidate reports.',
  },
  flipkart: {
    confidence: 'medium',
    source: 'https://www.flipkartcareers.com/',
    sourceLabel: 'Flipkart careers + public candidate reports (India)',
    reviewedAt: '2026-09-01',
    evidence: 'DSA + machine-coding rounds with system design for seniors; India-product loop consistent with public reports.',
  },
};
...
export function getCompanyLoop(companyId, level) {
  ...
  return {
    ...
    rounds,
    // provenance: vetted profiles carry their public source; the rest are
    // honest archetype practice loops (no "actual sequence" claim).
    vetted: VETTED[companyId] ?? null,
  };
}
