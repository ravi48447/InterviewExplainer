...
export const MOCK_MODES = [
  ...
  },
  {
    ...
    description: 'Priya\'s rapid-fire round: short questions, instant follow-ups, no time to ramble. Trains crispness.',
    plan: 'free',
  ...
  },
  {
    ...
    description: 'Dana\'s architecture round: scale questions, capacity math, every answer meets "at what scale?"',
    plan: 'interview_pass',
