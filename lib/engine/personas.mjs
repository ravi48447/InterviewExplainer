...
export const PERSONAS = {
  mentor: {
    id: 'mentor',
    name: 'Aisha',
    title: 'Friendly Mentor · Senior Engineer',
  ...
  skeptic: {
    id: 'skeptic',
    name: 'Marcus',
    title: 'The Skeptic · Staff Engineer',
  ...
  rapid: {
    id: 'rapid',
    name: 'Priya',
    title: 'Rapid Interviewer · Hiring Manager',
  ...
  detail: {
    id: 'detail',
    name: 'Elena',
    title: 'Detail Interviewer · Tech Lead',
  ...
  architect: {
    id: 'architect',
    name: 'Dana',
    title: 'Principal Architect · Systems',
  ...
  silent: {
    id: 'silent',
    name: 'The Panel',
    title: 'Silent Judge · Interview Panel',
