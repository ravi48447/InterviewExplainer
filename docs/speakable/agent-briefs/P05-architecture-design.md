# Pillar P05 — Architecture & Design agent brief

> Phase 3a/3b agent brief generated by `scripts/build_agent_briefs.py`. Self-contained: an agent reading only this brief, the lint script `scripts/audit_speakable.py`, the codex JSONs, and the 7 golden references embedded below can refine this pillar's queue to lint-green output. Phase 3a smoke gate: draft **only the first question** in `content/_audits/agent-queues/P05-queue.csv`, halt for human review. (Per the SPEAKABLE-PHASE-3A-PROMPT.md §1.5 + §7.4.)
...
- **Number of questions in scope** (excludes 7 goldens + 30 priority_handcraft + already-approved): **74**
- **Question list:** see `content/_audits/agent-queues/P05-queue.csv` (columns: slug, archetype, confidence, importance, difficulty, module, topic, file).
...
|---:|---|---|---|---|---|
| 1 | `datafetcher-and-dataloader-graphql-java` | A | medium | high | `graphql/graphql-fundamentals` |
| 2 | `graphql-authentication-authorization-spring-boot` | A | medium | high | `graphql/graphql-fundamentals` |
| 3 | `graphql-error-handling-spring-boot` | A | medium | high | `graphql/graphql-fundamentals` |
| 4 | `graphql-n-plus-one-problem-batchloader` | A | medium | high | `graphql/graphql-fundamentals` |
| 5 | `graphql-pagination-cursor-vs-offset` | B | medium | high | `graphql/graphql-fundamentals` |
| 6 | `graphql-query-mutation-subscription-differences` | A | medium | high | `graphql/graphql-fundamentals` |
| 7 | `graphql-schema-design-best-practices` | A | medium | high | `graphql/graphql-fundamentals` |
| 8 | `graphql-vs-rest-when-to-choose` | B | medium | high | `graphql/graphql-fundamentals` |
| 9 | `grpc-vs-rest-vs-graphql` | B | medium | high | `graphql/graphql-fundamentals` |
| 10 | `setting-up-spring-for-graphql` | A | medium | high | `graphql/graphql-fundamentals` |
| 11 | `testing-graphql-endpoints-spring-boot` | A | medium | high | `graphql/graphql-fundamentals` |
| 12 | `grpc-deadlines-cancellation-java` | A | medium | high | `grpc/grpc-fundamentals` |
| 13 | `grpc-error-handling-status-codes` | A | medium | high | `grpc/grpc-fundamentals` |
| 14 | `grpc-health-checking-protocol` | A | medium | high | `grpc/grpc-fundamentals` |
| 15 | `grpc-interceptors-auth-logging` | A | medium | high | `grpc/grpc-fundamentals` |
| 16 | `grpc-server-spring-boot-setup` | A | medium | high | `grpc/grpc-fundamentals` |
| 17 | `grpc-service-types-java` | A | medium | high | `grpc/grpc-fundamentals` |
| 18 | `grpc-vs-rest-performance` | B | medium | high | `grpc/grpc-fundamentals` |
| 19 | `testing-grpc-services-java` | A | medium | high | `grpc/grpc-fundamentals` |
| 20 | `rabbitmq-acknowledgment-modes` | B | medium | high | `rabbitmq/rabbitmq-fundamentals` |
| 21 | `rabbitmq-clustering-high-availability` | A | medium | high | `rabbitmq/rabbitmq-fundamentals` |
| 22 | `rabbitmq-exchange-types` | A | medium | high | `rabbitmq/rabbitmq-fundamentals` |
| 23 | `rabbitmq-message-durability` | A | medium | high | `rabbitmq/rabbitmq-fundamentals` |
| 24 | `rabbitmq-publisher-confirms` | A | medium | high | `rabbitmq/rabbitmq-fundamentals` |
| 25 | `rabbitmq-vs-kafka` | B | medium | high | `rabbitmq/rabbitmq-fundamentals` |
...
```jsonc
{
  ...
  "pillar": "P05",  // exactly this pillar code
...
_Topics in scope (codex `topic_id`s touched by this pillar's queue): 2._
...
[
  {
    "topic_id": "solid-principles",
    "example": "ReportPrinter doing only printing (SRP); PaymentProcessor depending on PaymentMethod abstraction (DIP)",
    "use_when": "showing two of the five on one familiar shape",
    "source": "agent-seeded"
  },
  {
    "topic_id": "hexagonal-clean-architecture",
    "example": "OrderService (domain) + OrderRepository (port) + JpaOrderRepository (adapter)",
    "use_when": "the canonical port-and-adapter mapping",
    "source": "agent-seeded"
  }
]
```
...
- **Never** cross pillar boundaries. This brief is scoped to P05 only.
...
All 74 questions in scope, sorted by importance, then difficulty, then slug. Phase 3b iterates this list; Phase 3a smoke targets row 1.

| # | slug | archetype | confidence | importance | difficulty | module | topic |
|---:|---|---|---|---|---|---|---|
| 1 | `datafetcher-and-dataloader-graphql-java` | A | medium | high | intermediate | `graphql` | `graphql-fundamentals` |
| 2 | `graphql-authentication-authorization-spring-boot` | A | medium | high | intermediate | `graphql` | `graphql-fundamentals` |
| 3 | `graphql-error-handling-spring-boot` | A | medium | high | intermediate | `graphql` | `graphql-fundamentals` |
| 4 | `graphql-n-plus-one-problem-batchloader` | A | medium | high | intermediate | `graphql` | `graphql-fundamentals` |
| 5 | `graphql-pagination-cursor-vs-offset` | B | medium | high | intermediate | `graphql` | `graphql-fundamentals` |
| 6 | `graphql-query-mutation-subscription-differences` | A | medium | high | intermediate | `graphql` | `graphql-fundamentals` |
| 7 | `graphql-schema-design-best-practices` | A | medium | high | intermediate | `graphql` | `graphql-fundamentals` |
| 8 | `graphql-vs-rest-when-to-choose` | B | medium | high | intermediate | `graphql` | `graphql-fundamentals` |
| 9 | `grpc-vs-rest-vs-graphql` | B | medium | high | intermediate | `graphql` | `graphql-fundamentals` |
| 10 | `setting-up-spring-for-graphql` | A | medium | high | intermediate | `graphql` | `graphql-fundamentals` |
| 11 | `testing-graphql-endpoints-spring-boot` | A | medium | high | intermediate | `graphql` | `graphql-fundamentals` |
| 12 | `grpc-deadlines-cancellation-java` | A | medium | high | intermediate | `grpc` | `grpc-fundamentals` |
| 13 | `grpc-error-handling-status-codes` | A | medium | high | intermediate | `grpc` | `grpc-fundamentals` |
| 14 | `grpc-health-checking-protocol` | A | medium | high | intermediate | `grpc` | `grpc-fundamentals` |
| 15 | `grpc-interceptors-auth-logging` | A | medium | high | intermediate | `grpc` | `grpc-fundamentals` |
| 16 | `grpc-server-spring-boot-setup` | A | medium | high | intermediate | `grpc` | `grpc-fundamentals` |
| 17 | `grpc-service-types-java` | A | medium | high | intermediate | `grpc` | `grpc-fundamentals` |
| 18 | `grpc-vs-rest-performance` | B | medium | high | intermediate | `grpc` | `grpc-fundamentals` |
| 19 | `testing-grpc-services-java` | A | medium | high | intermediate | `grpc` | `grpc-fundamentals` |
| 20 | `rabbitmq-acknowledgment-modes` | B | medium | high | intermediate | `rabbitmq` | `rabbitmq-fundamentals` |
| 21 | `rabbitmq-clustering-high-availability` | A | medium | high | intermediate | `rabbitmq` | `rabbitmq-fundamentals` |
| 22 | `rabbitmq-exchange-types` | A | medium | high | intermediate | `rabbitmq` | `rabbitmq-fundamentals` |
| 23 | `rabbitmq-message-durability` | A | medium | high | intermediate | `rabbitmq` | `rabbitmq-fundamentals` |
| 24 | `rabbitmq-publisher-confirms` | A | medium | high | intermediate | `rabbitmq` | `rabbitmq-fundamentals` |
| 25 | `rabbitmq-vs-kafka` | B | medium | high | intermediate | `rabbitmq` | `rabbitmq-fundamentals` |
| 26 | `spring-amqp-setup` | A | medium | high | intermediate | `rabbitmq` | `rabbitmq-fundamentals` |
| 27 | `spring-amqp-testing-embedded` | A | medium | high | intermediate | `rabbitmq` | `rabbitmq-fundamentals` |
| 28 | `dead-letter-queue-spring-kafka-rabbitmq` | A | medium | medium | medium | `rabbitmq` | `rabbitmq-fundamentals` |
| 29 | `layered-vs-hexagonal-vs-clean-vs-onion` | B | high | — | medium | `architecture-patterns` | `comparisons` |
| 30 | `observer-pattern-spring-events-java` | A | medium | — | medium | `design-patterns` | `behavioral-patterns` |
| 31 | `strategy-pattern-replace-if-else-java` | A | medium | — | medium | `design-patterns` | `behavioral-patterns` |
| 32 | `template-method-pattern-spring-jdbctemplate` | A | medium | — | medium | `design-patterns` | `behavioral-patterns` |
| 33 | `gof-design-patterns-vs-modern-alternatives-java` | B | high | — | medium | `design-patterns` | `comparisons` |
| 34 | `builder-pattern-fluent-api-java` | A | medium | — | medium | `design-patterns` | `creational-patterns` |
| 35 | `factory-method-vs-abstract-factory-java` | E | high | — | medium | `design-patterns` | `creational-patterns` |
| 36 | `singleton-thread-safe-java` | B | medium | — | medium | `design-patterns` | `creational-patterns` |
| 37 | `circuit-breaker-pattern-resilience4j-java` | A | medium | — | medium | `design-patterns` | `design-patterns-legacy` |
| 38 | `cqrs-pattern-spring-java` | A | medium | — | medium | `design-patterns` | `design-patterns-legacy` |
| 39 | `repository-vs-dao-pattern-spring-data` | B | medium | — | medium | `design-patterns` | `design-patterns-legacy` |
| 40 | `specification-pattern-complex-queries-java` | A | medium | — | medium | `design-patterns` | `design-patterns-legacy` |
| 41 | `refactoring-legacy-java-code-safely-incrementally` | B | medium | — | medium | `design-patterns` | `refactoring` |
| 42 | `decorator-pattern-java-behavior-without-subclassing` | A | medium | — | medium | `design-patterns` | `structural-patterns` |
| 43 | `proxy-pattern-spring-aop-java` | A | medium | — | medium | `design-patterns` | `structural-patterns` |
| 44 | `patterns-as-technical-debt-over-engineering` | A | medium | — | medium | `design-patterns` | `technical-debt` |
| 45 | `modular-monolith-to-microservices-migration` | D | high | — | hard | `architecture-patterns` | `scenario-based` |
| 46 | `backend-for-frontend-bff-pattern` | A | medium | — | intermediate | `architecture-patterns` | `architectural-styles` |
| 47 | `layered-architecture-spring-boot` | A | medium | — | intermediate | `architecture-patterns` | `architectural-styles` |
| 48 | `service-mesh-architecture` | A | low | — | intermediate | `architecture-patterns` | `architectural-styles` |
| 49 | `clean-architecture-layers-dependency-rule` | A | medium | — | intermediate | `architecture-patterns` | `clean-architecture` |
| 50 | `clean-architecture-vs-layered-architecture` | B | medium | — | intermediate | `architecture-patterns` | `clean-architecture` |
| 51 | `cross-cutting-concerns-clean-architecture` | A | medium | — | intermediate | `architecture-patterns` | `clean-architecture` |
| 52 | `repository-pattern-clean-architecture` | B | medium | — | intermediate | `architecture-patterns` | `clean-architecture` |
| 53 | `rich-domain-model-vs-anemic-domain-model` | B | medium | — | intermediate | `architecture-patterns` | `clean-architecture` |
| 54 | `spring-boot-clean-architecture-project-structure` | A | medium | — | intermediate | `architecture-patterns` | `clean-architecture` |
| 55 | `unit-testing-clean-architecture-java` | A | medium | — | intermediate | `architecture-patterns` | `clean-architecture` |
| 56 | `use-case-interactor-pattern-java` | A | medium | — | intermediate | `architecture-patterns` | `clean-architecture` |
| 57 | `when-not-to-use-clean-architecture` | A | medium | — | intermediate | `architecture-patterns` | `clean-architecture` |
| 58 | `event-sourcing-pattern` | A | medium | — | intermediate | `architecture-patterns` | `cqrs-and-event-sourcing` |
| 59 | `aggregate-aggregate-root-ddd` | A | medium | — | intermediate | `architecture-patterns` | `domain-driven-design` |
| 60 | `anti-corruption-layer-ddd` | A | medium | — | intermediate | `architecture-patterns` | `domain-driven-design` |
| 61 | `bounded-context-ddd` | A | medium | — | intermediate | `architecture-patterns` | `domain-driven-design` |
| 62 | `ddd-tactical-patterns-spring-boot` | A | medium | — | intermediate | `architecture-patterns` | `domain-driven-design` |
| 63 | `domain-events-ddd-java` | A | medium | — | intermediate | `architecture-patterns` | `domain-driven-design` |
| 64 | `domain-services-vs-application-services-ddd` | B | medium | — | intermediate | `architecture-patterns` | `domain-driven-design` |
| 65 | `entity-vs-value-object-ddd` | B | medium | — | intermediate | `architecture-patterns` | `domain-driven-design` |
| 66 | `repository-pattern-ddd` | A | medium | — | intermediate | `architecture-patterns` | `domain-driven-design` |
| 67 | `strategic-ddd-context-mapping-patterns` | A | medium | — | intermediate | `architecture-patterns` | `domain-driven-design` |
| 68 | `ubiquitous-language-ddd` | A | medium | — | intermediate | `architecture-patterns` | `domain-driven-design` |
| 69 | `hexagonal-architecture-ports-adapters` | A | medium | — | intermediate | `architecture-patterns` | `hexagonal-architecture` |
| 70 | `ports-and-adapters-hexagonal-architecture` | B | medium | — | intermediate | `architecture-patterns` | `hexagonal-architecture` |
| 71 | `monolith-vs-microservices-vs-modular-monolith` | B | medium | — | intermediate | `architecture-patterns` | `microservices-patterns` |
| 72 | `shared-database-vs-database-per-service` | B | medium | — | intermediate | `architecture-patterns` | `microservices-patterns` |
| 73 | `strangler-fig-pattern-migration` | A | medium | — | intermediate | `architecture-patterns` | `microservices-patterns` |
| 74 | `solid-principles-java` | A | medium | — | intermediate | `design-patterns` | `solid-principles` |
