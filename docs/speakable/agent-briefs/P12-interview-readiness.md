# Pillar P12 — Interview Readiness agent brief

> Phase 3a/3b agent brief generated by `scripts/build_agent_briefs.py`. Self-contained: an agent reading only this brief, the lint script `scripts/audit_speakable.py`, the codex JSONs, and the 7 golden references embedded below can refine this pillar's queue to lint-green output. Phase 3a smoke gate: draft **only the first question** in `content/_audits/agent-queues/P12-queue.csv`, halt for human review. (Per the SPEAKABLE-PHASE-3A-PROMPT.md §1.5 + §7.4.)
...
- **Number of questions in scope** (excludes 7 goldens + 30 priority_handcraft + already-approved): **13**
- **Question list:** see `content/_audits/agent-queues/P12-queue.csv` (columns: slug, archetype, confidence, importance, difficulty, module, topic, file).
...
|---:|---|---|---|---|---|
| 1 | `learn-new-technology-quickly` | G | high | — | `behavioral/career-growth` |
| 2 | `stay-current-with-java-technology` | G | high | — | `behavioral/career-growth` |
| 3 | `ensure-code-quality-under-pressure` | G | high | — | `behavioral/delivering-under-pressure` |
| 4 | `prioritize-multiple-urgent-tasks` | G | high | — | `behavioral/delivering-under-pressure` |
| 5 | `project-failure-and-lessons-learned` | G | high | — | `behavioral/failure-and-learning` |
| 6 | `debug-complex-production-issue` | G | high | — | `behavioral/star-method` |
| 7 | `identifying-prioritizing-paying-down-technical-debt` | G | high | — | `engineering-practices/technical-debt` |
| 8 | `technical-documentation-engineering-teams-strategy` | G | high | — | `engineering-practices/technical-documentation` |
| 9 | `advocate-for-technical-debt` | G | high | — | `engineering-practices/technical-leadership` |
| 10 | `approach-code-reviews` | G | high | — | `engineering-practices/technical-leadership` |
| 11 | `end-to-end-project-ownership` | G | high | — | `engineering-practices/technical-leadership` |
| 12 | `improve-system-performance` | G | high | — | `engineering-practices/technical-leadership` |
| 13 | `mentor-junior-developer` | G | high | — | `engineering-practices/technical-leadership` |
...
```jsonc
{
  ...
  "pillar": "P12",  // exactly this pillar code
...
[
  {
    "topic_id": "star-method",
    "example": "S: payment integration / T: ship in 3 weeks / A: cut scope, feature-flag / R: shipped on time / Reflection: escalate sooner next time",
    "use_when": "a balanced STAR walk-through",
    "source": "agent-seeded"
  },
  {
    "topic_id": "failure-and-learning",
    "example": "shipped a migration without a reverse plan; lost 40 minutes during P0; now write the rollback first",
    "use_when": "the canonical own-it-then-learn arc",
    "source": "agent-seeded"
  }
]
```
...
- **Never** cross pillar boundaries. This brief is scoped to P12 only.
...
All 13 questions in scope, sorted by importance, then difficulty, then slug. Phase 3b iterates this list; Phase 3a smoke targets row 1.

| # | slug | archetype | confidence | importance | difficulty | module | topic |
|---:|---|---|---|---|---|---|---|
| 1 | `learn-new-technology-quickly` | G | high | — | medium | `behavioral` | `career-growth` |
| 2 | `stay-current-with-java-technology` | G | high | — | medium | `behavioral` | `career-growth` |
| 3 | `ensure-code-quality-under-pressure` | G | high | — | medium | `behavioral` | `delivering-under-pressure` |
| 4 | `prioritize-multiple-urgent-tasks` | G | high | — | medium | `behavioral` | `delivering-under-pressure` |
| 5 | `project-failure-and-lessons-learned` | G | high | — | medium | `behavioral` | `failure-and-learning` |
| 6 | `debug-complex-production-issue` | G | high | — | medium | `behavioral` | `star-method` |
| 7 | `identifying-prioritizing-paying-down-technical-debt` | G | high | — | medium | `engineering-practices` | `technical-debt` |
| 8 | `technical-documentation-engineering-teams-strategy` | G | high | — | medium | `engineering-practices` | `technical-documentation` |
| 9 | `advocate-for-technical-debt` | G | high | — | medium | `engineering-practices` | `technical-leadership` |
| 10 | `approach-code-reviews` | G | high | — | medium | `engineering-practices` | `technical-leadership` |
| 11 | `end-to-end-project-ownership` | G | high | — | medium | `engineering-practices` | `technical-leadership` |
| 12 | `improve-system-performance` | G | high | — | medium | `engineering-practices` | `technical-leadership` |
| 13 | `mentor-junior-developer` | G | high | — | medium | `engineering-practices` | `technical-leadership` |
