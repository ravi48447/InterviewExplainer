# Pillar P01 — Java Language & Core agent brief

> Phase 3a/3b agent brief generated by `scripts/build_agent_briefs.py`. Self-contained: an agent reading only this brief, the lint script `scripts/audit_speakable.py`, the codex JSONs, and the 7 golden references embedded below can refine this pillar's queue to lint-green output. Phase 3a smoke gate: draft **only the first question** in `content/_audits/agent-queues/P01-queue.csv`, halt for human review. (Per the SPEAKABLE-PHASE-3A-PROMPT.md §1.5 + §7.4.)
...
- **Number of questions in scope** (excludes 7 goldens + 30 priority_handcraft + already-approved): **249**
- **Question list:** see `content/_audits/agent-queues/P01-queue.csv` (columns: slug, archetype, confidence, importance, difficulty, module, topic, file).
...
|---:|---|---|---|---|---|
| 1 | `checked-vs-unchecked-exception-java-comparison` | B | high | high | `core-java/comparisons` |
| 2 | `throw-vs-throws-java-difference` | E | high | high | `core-java/exception-handling` |
| 3 | `generics-in-java-introduction-and-benefits` | A | medium | high | `core-java/generics-wildcards` |
| 4 | `java-io-streams-overview-byte-vs-character` | B | medium | high | `core-java/java-io-nio` |
| 5 | `what-is-reflection-in-java-use-cases` | A | medium | high | `core-java/reflection-annotations` |
| 6 | `string-equals-vs-contentequals-java` | E | high | high | `core-java/string-handling` |
| 7 | `why-string-is-immutable-in-java` | A | medium | high | `core-java/string-handling` |
| 8 | `big-o-notation-introduction-java` | A | medium | high | `java-collections/algorithm-complexity` |
| 9 | `time-complexity-common-operations-java` | A | medium | high | `java-collections/algorithm-complexity` |
| 10 | `array-vs-arraylist-java-comparison` | E | high | high | `java-collections/comparisons` |
| 11 | `stack-vs-queue-java-comparison` | B | high | high | `java-collections/comparisons` |
| 12 | `dynamic-programming-introduction-java` | A | medium | high | `java-collections/dynamic-programming` |
| 13 | `fibonacci-dp-java` | A | medium | high | `java-collections/dynamic-programming` |
| 14 | `check-anagram-java` | B | medium | high | `java-collections/scenario-based` |
| 15 | `java-sorting-algorithms-overview` | A | medium | high | `java-collections/sorting-and-searching` |
| 16 | `binary-tree-vs-binary-search-tree-java` | B | medium | high | `java-collections/trees-and-graphs` |
| 17 | `what-is-completablefuture-java` | A | medium | high | `java-concurrency/completable-future` |
| 18 | `why-concurrent-collections-java` | A | medium | high | `java-concurrency/concurrent-collections` |
| 19 | `synchronized-method-vs-block-java` | B | medium | high | `java-concurrency/synchronization-and-locks` |
| 20 | `what-is-synchronization-java` | A | medium | high | `java-concurrency/synchronization-and-locks` |
| 21 | `why-use-thread-pool-java` | A | medium | high | `java-concurrency/thread-pools-and-executor` |
| 22 | `thread-sleep-vs-wait-java` | E | high | high | `java-concurrency/threads-and-lifecycle` |
| 23 | `thread-start-vs-run-java` | B | medium | high | `java-concurrency/threads-and-lifecycle` |
| 24 | `what-is-thread-in-java` | A | medium | high | `java-concurrency/threads-and-lifecycle` |
| 25 | `abstract-class-vs-interface-java-comparison` | B | high | high | `java-oop/comparisons` |
...
```jsonc
{
  ...
  "pillar": "P01",  // exactly this pillar code
...
[
  {
    "topic_id": "synchronization-and-locks",
    "example": "synchronized block on a private final Object lock",
    "use_when": "showing intrinsic-lock idiom safely",
    "source": "agent-seeded"
  },
  {
    "topic_id": "garbage-collection-generations",
    "example": "young → survivor → old, with G1 default since Java 9",
    "use_when": "naming the spaces and the modern default",
    "source": "agent-seeded"
  },
  {
    "topic_id": "exception-handling-controlleradvice",
    "example": "@ControllerAdvice mapping IllegalArgumentException → 400",
    "use_when": "the canonical mapping example",
    "source": "agent-seeded"
  }
]
```
...
- **Never** cross pillar boundaries. This brief is scoped to P01 only.
...
All 249 questions in scope, sorted by importance, then difficulty, then slug. Phase 3b iterates this list; Phase 3a smoke targets row 1.

| # | slug | archetype | confidence | importance | difficulty | module | topic |
|---:|---|---|---|---|---|---|---|
| 1 | `checked-vs-unchecked-exception-java-comparison` | B | high | high | easy | `core-java` | `comparisons` |
| 2 | `throw-vs-throws-java-difference` | E | high | high | easy | `core-java` | `exception-handling` |
| 3 | `generics-in-java-introduction-and-benefits` | A | medium | high | easy | `core-java` | `generics-wildcards` |
| 4 | `java-io-streams-overview-byte-vs-character` | B | medium | high | easy | `core-java` | `java-io-nio` |
| 5 | `what-is-reflection-in-java-use-cases` | A | medium | high | easy | `core-java` | `reflection-annotations` |
| 6 | `string-equals-vs-contentequals-java` | E | high | high | easy | `core-java` | `string-handling` |
| 7 | `why-string-is-immutable-in-java` | A | medium | high | easy | `core-java` | `string-handling` |
| 8 | `big-o-notation-introduction-java` | A | medium | high | easy | `java-collections` | `algorithm-complexity` |
| 9 | `time-complexity-common-operations-java` | A | medium | high | easy | `java-collections` | `algorithm-complexity` |
| 10 | `array-vs-arraylist-java-comparison` | E | high | high | easy | `java-collections` | `comparisons` |
| 11 | `stack-vs-queue-java-comparison` | B | high | high | easy | `java-collections` | `comparisons` |
| 12 | `dynamic-programming-introduction-java` | A | medium | high | easy | `java-collections` | `dynamic-programming` |
| 13 | `fibonacci-dp-java` | A | medium | high | easy | `java-collections` | `dynamic-programming` |
| 14 | `check-anagram-java` | B | medium | high | easy | `java-collections` | `scenario-based` |
| 15 | `java-sorting-algorithms-overview` | A | medium | high | easy | `java-collections` | `sorting-and-searching` |
| 16 | `binary-tree-vs-binary-search-tree-java` | B | medium | high | easy | `java-collections` | `trees-and-graphs` |
| 17 | `what-is-completablefuture-java` | A | medium | high | easy | `java-concurrency` | `completable-future` |
| 18 | `why-concurrent-collections-java` | A | medium | high | easy | `java-concurrency` | `concurrent-collections` |
| 19 | `synchronized-method-vs-block-java` | B | medium | high | easy | `java-concurrency` | `synchronization-and-locks` |
| 20 | `what-is-synchronization-java` | A | medium | high | easy | `java-concurrency` | `synchronization-and-locks` |
| 21 | `why-use-thread-pool-java` | A | medium | high | easy | `java-concurrency` | `thread-pools-and-executor` |
| 22 | `thread-sleep-vs-wait-java` | E | high | high | easy | `java-concurrency` | `threads-and-lifecycle` |
| 23 | `thread-start-vs-run-java` | B | medium | high | easy | `java-concurrency` | `threads-and-lifecycle` |
| 24 | `what-is-thread-in-java` | A | medium | high | easy | `java-concurrency` | `threads-and-lifecycle` |
| 25 | `abstract-class-vs-interface-java-comparison` | B | high | high | easy | `java-oop` | `comparisons` |
| 26 | `optional-vs-null-java-comparison` | B | high | high | easy | `java-streams` | `comparisons` |
| 27 | `stream-vs-collection-java-comparison` | B | high | high | easy | `java-streams` | `comparisons` |
| 28 | `java-records` | A | medium | high | easy | `java-streams` | `java-14-to-17-features` |
| 29 | `pattern-matching-instanceof-java` | A | medium | high | easy | `java-streams` | `java-14-to-17-features` |
| 30 | `switch-expressions` | A | medium | high | easy | `java-streams` | `java-14-to-17-features` |
| 31 | `java-10-var-local-variable-type-inference` | A | medium | high | easy | `java-streams` | `java-9-to-11-features` |
| 32 | `java-9-factory-methods-list-of-set-of-map-of` | A | medium | high | easy | `java-streams` | `java-9-to-11-features` |
| 33 | `functional-interface-java-explained` | A | medium | high | easy | `java-streams` | `lambdas-functional-interfaces` |
| 34 | `lambdas-functional-interfaces` | A | medium | high | easy | `java-streams` | `lambdas-functional-interfaces` |
| 35 | `predicate-function-consumer-supplier-java` | A | medium | high | easy | `java-streams` | `lambdas-functional-interfaces` |
| 36 | `streams-api` | A | medium | high | easy | `java-streams` | `lambdas-functional-interfaces` |
| 37 | `what-is-lambda-expression-java` | A | medium | high | easy | `java-streams` | `lambdas-functional-interfaces` |
| 38 | `optional-of-ofNullable-empty-java` | E | high | high | easy | `java-streams` | `optional-api` |
| 39 | `what-is-optional-in-java` | A | medium | high | easy | `java-streams` | `optional-api` |
| 40 | `convert-list-to-map-java-streams` | D | high | high | easy | `java-streams` | `scenario-based` |
| 41 | `flatten-list-of-lists-java-streams` | D | high | high | easy | `java-streams` | `scenario-based` |
| 42 | `group-objects-by-field-java-streams` | D | high | high | easy | `java-streams` | `scenario-based` |
| 43 | `intermediate-vs-terminal-operations-java` | B | medium | high | easy | `java-streams` | `streams-api` |
| 44 | `lambda-fundamentals` | A | medium | high | easy | `java-streams` | `streams-api` |
| 45 | `what-is-java-stream-api` | A | medium | high | easy | `java-streams` | `streams-api` |
| 46 | `what-is-garbage-collection-java` | A | medium | high | easy | `jvm-internals` | `garbage-collection` |
| 47 | `heap-vs-stack-memory-java` | B | medium | high | easy | `jvm-internals` | `jvm-architecture` |
| 48 | `jvm-jre-jdk-difference` | B | medium | high | easy | `jvm-internals` | `jvm-architecture` |
| 49 | `jvm-flags-xms-xmx-java` | A | medium | high | easy | `jvm-internals` | `jvm-tuning` |
| 50 | `heap-vs-stack-memory-java-comparison` | B | high | high | medium | `core-java` | `comparisons` |
| 51 | `best-practices-for-exception-handling-java` | A | medium | high | medium | `core-java` | `exception-handling` |
| 52 | `finally-block-execution-rules-java` | A | medium | high | medium | `core-java` | `exception-handling` |
| 53 | `bounded-vs-unbounded-wildcards-java` | B | medium | high | medium | `core-java` | `generics-wildcards` |
| 54 | `pecs-principle-producer-extends-consumer-super` | A | medium | high | medium | `core-java` | `generics-wildcards` |
| 55 | `channels-and-buffers-java-nio` | A | medium | high | medium | `core-java` | `java-io-nio` |
| 56 | `how-to-read-large-file-efficiently-java` | A | medium | high | medium | `core-java` | `java-io-nio` |
| 57 | `java-nio-vs-io-comparison` | B | medium | high | medium | `core-java` | `java-io-nio` |
| 58 | `serialization-vs-externalizable-java` | E | high | high | medium | `core-java` | `java-io-nio` |
| 59 | `custom-annotations` | A | medium | high | medium | `core-java` | `reflection-annotations` |
| 60 | `meta-annotations-retention-target` | A | medium | high | medium | `core-java` | `reflection-annotations` |
| 61 | `reflection-basics` | A | medium | high | medium | `core-java` | `reflection-annotations` |
| 62 | `string-intern-method-java-explained` | A | medium | high | medium | `core-java` | `string-handling` |
| 63 | `amortized-complexity-arraylist-hashmap-java` | A | medium | high | medium | `java-collections` | `algorithm-complexity` |
| 64 | `list-vs-set-vs-map-overview` | E | high | high | medium | `java-collections` | `collections-internals` |
| 65 | `map-compute-merge-methods` | C | high | high | medium | `java-collections` | `collections-internals` |
| 66 | `stream-api-with-collections` | C | high | high | medium | `java-collections` | `collections-internals` |
| 67 | `treeset-treemap-navigable` | C | high | high | medium | `java-collections` | `collections-internals` |
| 68 | `hashmap-vs-concurrenthashmap-comparison` | B | high | high | medium | `java-collections` | `comparisons` |
| 69 | `memoization-vs-tabulation-java` | B | medium | high | medium | `java-collections` | `dynamic-programming` |
| 70 | `fast-and-slow-pointers-java` | A | medium | high | medium | `java-collections` | `problem-solving-patterns` |
| 71 | `sliding-window-technique-java` | B | medium | high | medium | `java-collections` | `problem-solving-patterns` |
| 72 | `top-k-elements-heap-java` | A | medium | high | medium | `java-collections` | `problem-solving-patterns` |
| 73 | `two-pointers-technique-java` | A | medium | high | medium | `java-collections` | `problem-solving-patterns` |
| 74 | `detect-loop-in-linked-list-java` | D | high | high | medium | `java-collections` | `scenario-based` |
| 75 | `reverse-linked-list-java-iterative-recursive` | D | high | high | medium | `java-collections` | `scenario-based` |
| 76 | `timsort-java-collections-sort` | A | medium | high | medium | `java-collections` | `sorting-and-searching` |
| 77 | `graph-representation-adjacency-list-matrix-java` | B | medium | high | medium | `java-collections` | `trees-and-graphs` |
| 78 | `tree-traversal-inorder-preorder-postorder-java` | A | medium | high | medium | `java-collections` | `trees-and-graphs` |
| 79 | `future-vs-completablefuture-comparison` | B | high | high | medium | `java-concurrency` | `comparisons` |
| 80 | `virtual-vs-platform-threads-comparison` | B | high | high | medium | `java-concurrency` | `comparisons` |
| 81 | `volatile-vs-synchronized-comparison` | B | high | high | medium | `java-concurrency` | `comparisons` |
| 82 | `completablefuture-exception-handling-java` | B | medium | high | medium | `java-concurrency` | `completable-future` |
| 83 | `thencompose-vs-thencombine-java` | B | medium | high | medium | `java-concurrency` | `completable-future` |
| 84 | `producer-consumer-pattern-java` | B | medium | high | medium | `java-concurrency` | `concurrency-patterns` |
| 85 | `thread-safe-singleton-patterns-java` | A | medium | high | medium | `java-concurrency` | `concurrency-patterns` |
| 86 | `linkedblockingqueue-vs-arrayblockingqueue-java` | B | medium | high | medium | `java-concurrency` | `concurrent-collections` |
| 87 | `data-race-vs-race-condition-java` | B | medium | high | medium | `java-concurrency` | `java-memory-model` |
| 88 | `volatile-vs-atomic-java` | B | medium | high | medium | `java-concurrency` | `java-memory-model` |
| 89 | `what-is-java-memory-model-jmm` | A | medium | high | medium | `java-concurrency` | `java-memory-model` |
| 90 | `how-to-avoid-deadlock-java` | D | high | high | medium | `java-concurrency` | `scenario-based` |
| 91 | `how-to-detect-deadlock-java-thread-dump` | D | high | high | medium | `java-concurrency` | `scenario-based` |
| 92 | `fixed-vs-cached-vs-single-threadpool-java` | E | high | high | medium | `java-concurrency` | `thread-pools-and-executor` |
| 93 | `rejectedexecutionhandler-java` | A | medium | high | medium | `java-concurrency` | `thread-pools-and-executor` |
| 94 | `thread-interrupt-mechanism-java` | C | high | high | medium | `java-concurrency` | `threads-and-lifecycle` |
| 95 | `what-are-virtual-threads-java-21` | A | medium | high | medium | `java-concurrency` | `virtual-threads` |
| 96 | `when-to-use-virtual-threads-java` | A | medium | high | medium | `java-concurrency` | `virtual-threads` |
| 97 | `anonymous-inner-class-vs-lambda-java` | E | high | high | medium | `java-oop` | `oop-principles` |
| 98 | `diamond-problem-java-interfaces` | A | medium | high | medium | `java-oop` | `oop-principles` |
| 99 | `equals-and-hashcode-contract-java` | A | medium | high | medium | `java-oop` | `oop-principles` |
| 100 | `imperative-vs-functional-java-comparison` | B | high | high | medium | `java-streams` | `comparisons` |
| 101 | `sealed-classes` | A | medium | high | medium | `java-streams` | `java-14-to-17-features` |
| 102 | `pattern-matching-for-switch-java-21` | A | medium | high | medium | `java-streams` | `java-21-features` |
| 103 | `virtual-threads-java-21` | A | medium | high | medium | `java-streams` | `java-21-features` |
| 104 | `java-11-http-client-api` | A | medium | high | medium | `java-streams` | `java-9-to-11-features` |
| 105 | `java-9-module-system-jpms` | A | medium | high | medium | `java-streams` | `java-9-to-11-features` |
| 106 | `method-references-java-four-types` | A | medium | high | medium | `java-streams` | `lambdas-functional-interfaces` |
| 107 | `optional-usage` | A | medium | high | medium | `java-streams` | `lambdas-functional-interfaces` |
| 108 | `optional-as-return-type-best-practices-java` | A | medium | high | medium | `java-streams` | `optional-api` |
| 109 | `optional-orelse-vs-orelseget-java` | B | medium | high | medium | `java-streams` | `optional-api` |
| 110 | `collectors-groupingby-partitioningby-java` | B | medium | high | medium | `java-streams` | `streams-api` |
| 111 | `flatmap-vs-map-java-streams` | B | medium | high | medium | `java-streams` | `streams-api` |
| 112 | `lazy-evaluation-streams-java` | A | medium | high | medium | `java-streams` | `streams-api` |
| 113 | `optional-best-practices` | A | medium | high | medium | `java-streams` | `streams-api` |
| 114 | `parallel-stream-when-to-use-java` | A | medium | high | medium | `java-streams` | `streams-api` |
| 115 | `reduce-vs-collect-java-streams` | B | medium | high | medium | `java-streams` | `streams-api` |
| 116 | `stream-api-operations` | A | medium | high | medium | `java-streams` | `streams-api` |
| 117 | `aot-vs-jit-compilation-comparison` | B | high | high | medium | `jvm-internals` | `comparisons` |
| 118 | `minor-gc-vs-full-gc-comparison` | B | high | high | medium | `jvm-internals` | `comparisons` |
| 119 | `full-gc-vs-minor-gc-java` | B | medium | high | medium | `jvm-internals` | `garbage-collection` |
| 120 | `generational-gc-young-old-java` | B | medium | high | medium | `jvm-internals` | `garbage-collection` |
| 121 | `jvm-memory-areas` | A | medium | high | medium | `jvm-internals` | `jvm-architecture` |
| 122 | `metaspace-vs-permgen-java-8` | B | medium | high | medium | `jvm-internals` | `jvm-architecture` |
| 123 | `how-to-profile-java-application` | B | medium | high | medium | `jvm-internals` | `profiling-and-debugging` |
| 124 | `jfr-java-flight-recorder` | A | medium | high | medium | `jvm-internals` | `profiling-and-debugging` |
| 125 | `why-cant-create-generic-array-java` | B | medium | high | hard | `core-java` | `generics-wildcards` |
| 126 | `reflection-performance-cost-java` | A | medium | high | hard | `core-java` | `reflection-annotations` |
| 127 | `how-to-analyze-recursive-algorithm-complexity-java` | A | medium | high | hard | `java-collections` | `algorithm-complexity` |
| 128 | `knapsack-01-dp-java` | B | medium | high | hard | `java-collections` | `dynamic-programming` |
| 129 | `backtracking-java-pattern` | A | medium | high | hard | `java-collections` | `problem-solving-patterns` |
| 130 | `double-checked-locking-java` | A | medium | high | hard | `java-concurrency` | `concurrency-patterns` |
| 131 | `virtual-threads-pinning-problem-java` | A | medium | high | hard | `java-concurrency` | `virtual-threads` |
| 132 | `structured-concurrency-java-21` | A | medium | high | hard | `java-streams` | `java-21-features` |
| 133 | `parallel-vs-sequential-stream-decision-java` | B | medium | high | hard | `java-streams` | `scenario-based` |
| 134 | `collectors-advanced` | A | medium | high | hard | `java-streams` | `streams-api` |
| 135 | `stream-performance` | A | medium | high | hard | `java-streams` | `streams-api` |
| 136 | `g1-vs-cms-gc-java` | B | medium | high | hard | `jvm-internals` | `garbage-collection` |
| 137 | `zgc-shenandoah-low-latency-gc-java` | A | medium | high | hard | `jvm-internals` | `garbage-collection` |
| 138 | `tuning-jvm-microservices-containers-java` | G | medium | high | hard | `jvm-internals` | `jvm-tuning` |
| 139 | `heap-dump-analysis-mat-eclipse-java` | A | medium | high | hard | `jvm-internals` | `memory-analysis` |
| 140 | `how-to-find-memory-leak-java-production` | D | medium | high | hard | `jvm-internals` | `memory-analysis` |
| 141 | `how-to-investigate-oom-in-production-java` | D | high | high | hard | `jvm-internals` | `scenario-based` |
| 142 | `how-to-reduce-gc-pause-time-java` | D | high | high | hard | `jvm-internals` | `scenario-based` |
| 143 | `helpful-null-pointer-exceptions-java` | A | medium | medium | easy | `java-streams` | `java-14-to-17-features` |
| 144 | `text-blocks-string-templates` | A | medium | medium | easy | `java-streams` | `java-14-to-17-features` |
| 145 | `sequenced-collections-java-21` | A | medium | medium | easy | `java-streams` | `java-21-features` |
| 146 | `method-references` | A | medium | medium | easy | `java-streams` | `streams-api` |
| 147 | `collections-utility-class-methods` | C | high | medium | medium | `java-collections` | `collections-internals` |
| 148 | `iterator-vs-listiterator-java` | B | medium | medium | medium | `java-collections` | `collections-internals` |
| 149 | `annotation-processing` | A | medium | medium | hard | `core-java` | `reflection-annotations` |
| 150 | `final-finally-finalize-java-difference` | B | medium | — | easy | `core-java` | `scenario-based` |
| 151 | `java-autoboxing-unboxing-integer-cache` | D | high | — | easy | `core-java` | `scenario-based` |
| 152 | `java-pass-by-value-not-reference` | D | high | — | easy | `core-java` | `scenario-based` |
| 153 | `java-record-classes-what-they-are-when-to-use` | D | high | — | easy | `core-java` | `scenario-based` |
| 154 | `java-var-local-variable-type-inference-limitations` | D | high | — | easy | `core-java` | `scenario-based` |
| 155 | `string-vs-stringbuilder-vs-stringbuffer-java` | B | medium | — | easy | `core-java` | `string-handling` |
| 156 | `method-overloading-vs-overriding-java` | B | medium | — | easy | `java-oop` | `oop-principles` |
| 157 | `checked-vs-unchecked-exceptions-java-when-to-use` | B | medium | — | medium | `core-java` | `exception-handling` |
| 158 | `java-optional-prevent-null-pointer-exception` | A | medium | — | medium | `core-java` | `exception-handling` |
| 159 | `java-generics-type-erasure-explained` | A | medium | — | medium | `core-java` | `generics-wildcards` |
| 160 | `how-does-hashmap-work-internally-java` | D | high | — | medium | `core-java` | `scenario-based` |
| 161 | `java-functional-interfaces-lambdas-explained` | D | high | — | medium | `core-java` | `scenario-based` |
| 162 | `java-method-references-four-types` | D | high | — | medium | `core-java` | `scenario-based` |
| 163 | `java-stream-collectors-groupingby-tomap` | D | high | — | medium | `core-java` | `scenario-based` |
| 164 | `java-stream-map-vs-flatmap-difference` | B | medium | — | medium | `core-java` | `scenario-based` |
| 165 | `java-streams-lazy-evaluation-common-operations` | D | high | — | medium | `core-java` | `scenario-based` |
| 166 | `fail-fast-vs-fail-safe-iterators-java` | B | medium | — | medium | `java-collections` | `collections-internals` |
| 167 | `java-future-vs-completablefuture-comparison` | B | medium | — | medium | `java-concurrency` | `completable-future` |
| 168 | `how-to-create-immutable-class-java` | A | medium | — | medium | `java-oop` | `oop-principles` |
| 169 | `java-default-static-methods-interfaces` | A | medium | — | medium | `java-oop` | `oop-principles` |
| 170 | `static-keyword-java-explained` | A | medium | — | medium | `java-oop` | `oop-principles` |
| 171 | `classloader-hierarchy` | A | medium | — | medium | `jvm-internals` | `jvm-architecture` |
| 172 | `jit-compilation-tiered-compilation` | A | medium | — | medium | `jvm-internals` | `jvm-architecture` |
| 173 | `java-stackoverflow-vs-outofmemoryerror` | B | medium | — | medium | `jvm-internals` | `memory-analysis` |
| 174 | `how-java-garbage-collection-works` | D | high | — | hard | `core-java` | `scenario-based` |
| 175 | `custom-exceptions-java` | A | medium | — | intermediate | `core-java` | `exception-handling` |
| 176 | `exception-hierarchy-java` | A | medium | — | intermediate | `core-java` | `exception-handling` |
| 177 | `try-with-resources-autocloseable` | A | low | — | intermediate | `core-java` | `exception-handling` |
| 178 | `hashmap-resize-rehash-internals` | D | high | — | intermediate | `core-java` | `scenario-based` |
| 179 | `java-date-time-api` | D | high | — | intermediate | `core-java` | `scenario-based` |
| 180 | `java-records-generated-code` | D | high | — | intermediate | `core-java` | `scenario-based` |
| 181 | `parallel-streams-java` | B | medium | — | intermediate | `core-java` | `scenario-based` |
| 182 | `predicate-consumer-supplier-function` | D | high | — | intermediate | `core-java` | `scenario-based` |
| 183 | `sealed-classes-pattern-matching` | D | high | — | intermediate | `core-java` | `scenario-based` |
| 184 | `stream-collectors-joining-reducing` | D | high | — | intermediate | `core-java` | `scenario-based` |
| 185 | `type-casting-widening-narrowing` | B | medium | — | intermediate | `core-java` | `scenario-based` |
| 186 | `varargs-java` | D | high | — | intermediate | `core-java` | `scenario-based` |
| 187 | `weak-soft-phantom-references` | B | medium | — | intermediate | `core-java` | `scenario-based` |
| 188 | `string-pool-interning` | A | medium | — | intermediate | `core-java` | `string-handling` |
| 189 | `arraydeque-vs-linkedlist-queue-stack` | B | medium | — | intermediate | `java-collections` | `collections-internals` |
| 190 | `arraylist-vs-linkedlist` | E | high | — | intermediate | `java-collections` | `collections-internals` |
| 191 | `choosing-the-right-collection` | C | high | — | intermediate | `java-collections` | `collections-internals` |
| 192 | `comparable-vs-comparator` | B | medium | — | intermediate | `java-collections` | `collections-internals` |
| 193 | `comparator-thencomparing-reversed` | C | high | — | intermediate | `java-collections` | `collections-internals` |
| 194 | `copyonwritearraylist-when-and-why` | C | high | — | intermediate | `java-collections` | `collections-internals` |
| 195 | `enummap-enumset-performance` | C | high | — | intermediate | `java-collections` | `collections-internals` |
| 196 | `hashmap-vs-hashtable-vs-concurrenthashmap-java` | B | medium | — | intermediate | `java-collections` | `collections-internals` |
| 197 | `hashmap-vs-treemap-vs-linkedhashmap` | B | medium | — | intermediate | `java-collections` | `collections-internals` |
| 198 | `how-hashset-works-internally-java` | C | high | — | intermediate | `java-collections` | `collections-internals` |
| 199 | `priorityqueue-heap-structure` | C | high | — | intermediate | `java-collections` | `collections-internals` |
| 200 | `unmodifiable-list-vs-list-of-vs-list-copyof` | B | medium | — | intermediate | `java-collections` | `collections-internals` |
| 201 | `weakhashmap-gc-cache` | C | high | — | intermediate | `java-collections` | `collections-internals` |
| 202 | `completablefuture-chains` | A | medium | — | intermediate | `java-concurrency` | `completable-future` |
| 203 | `countdownlatch-vs-cyclicbarrier-vs-semaphore` | B | medium | — | intermediate | `java-concurrency` | `concurrency-patterns` |
| 204 | `threadlocal-use-cases-pitfalls` | A | medium | — | intermediate | `java-concurrency` | `concurrency-patterns` |
| 205 | `blockingqueue-producer-consumer` | A | medium | — | intermediate | `java-concurrency` | `concurrent-collections` |
| 206 | `concurrenthashmap-internals` | C | high | — | intermediate | `java-concurrency` | `concurrent-collections` |
| 207 | `java-memory-model-happens-before` | A | medium | — | intermediate | `java-concurrency` | `java-memory-model` |
| 208 | `volatile-visibility-guarantee` | A | medium | — | intermediate | `java-concurrency` | `java-memory-model` |
| 209 | `liveness-hazards-deadlock-livelock-starvation` | D | high | — | intermediate | `java-concurrency` | `scenario-based` |
| 210 | `parallel-streams-when-they-help-vs-hurt` | B | medium | — | intermediate | `java-concurrency` | `scenario-based` |
| 211 | `race-condition-identify-and-fix` | D | high | — | intermediate | `java-concurrency` | `scenario-based` |
| 212 | `atomicinteger-vs-synchronized` | E | high | — | intermediate | `java-concurrency` | `synchronization-and-locks` |
| 213 | `reentrant-read-write-lock` | A | medium | — | intermediate | `java-concurrency` | `synchronization-and-locks` |
| 214 | `stampedlock-optimistic-reads` | A | medium | — | intermediate | `java-concurrency` | `synchronization-and-locks` |
| 215 | `synchronized-keyword-monitors` | A | medium | — | intermediate | `java-concurrency` | `synchronization-and-locks` |
| 216 | `synchronized-vs-reentrantlock` | B | medium | — | intermediate | `java-concurrency` | `synchronization-and-locks` |
| 217 | `wait-notify-vs-condition-await-signal` | B | medium | — | intermediate | `java-concurrency` | `synchronization-and-locks` |
| 218 | `executorservice-thread-pool-types` | A | medium | — | intermediate | `java-concurrency` | `thread-pools-and-executor` |
| 219 | `forkjoinpool-recursive-task` | A | low | — | intermediate | `java-concurrency` | `thread-pools-and-executor` |
| 220 | `threadpool-sizing-cpu-io-bound` | B | medium | — | intermediate | `java-concurrency` | `thread-pools-and-executor` |
| 221 | `daemon-threads-java-explained` | A | medium | — | beginner | `java-concurrency` | `threads-and-lifecycle` |
| 222 | `thread-vs-runnable-vs-callable` | B | medium | — | intermediate | `java-concurrency` | `threads-and-lifecycle` |
| 223 | `java21-virtual-threads-structured-concurrency` | A | medium | — | intermediate | `java-concurrency` | `virtual-threads` |
| 224 | `abstraction-abstract-class-vs-interface` | E | high | — | intermediate | `java-oop` | `oop-principles` |
| 225 | `association-aggregation-composition` | B | medium | — | intermediate | `java-oop` | `oop-principles` |
| 226 | `compile-time-vs-runtime-polymorphism` | B | medium | — | intermediate | `java-oop` | `oop-principles` |
| 227 | `composition-vs-inheritance-java` | B | medium | — | intermediate | `java-oop` | `oop-principles` |
| 228 | `constructor-chaining-java` | A | medium | — | intermediate | `java-oop` | `oop-principles` |
| 229 | `encapsulation-access-modifiers-java` | A | medium | — | intermediate | `java-oop` | `oop-principles` |
| 230 | `enums-in-java` | A | medium | — | intermediate | `java-oop` | `oop-principles` |
| 231 | `inheritance-super-keyword-java` | A | medium | — | intermediate | `java-oop` | `oop-principles` |
| 232 | `inner-classes-java` | A | medium | — | intermediate | `java-oop` | `oop-principles` |
| 233 | `marker-interfaces-java` | A | medium | — | intermediate | `java-oop` | `oop-principles` |
| 234 | `object-class-methods-java` | A | medium | — | intermediate | `java-oop` | `oop-principles` |
| 235 | `oop-four-pillars-java` | A | medium | — | intermediate | `java-oop` | `oop-principles` |
| 236 | `serialization-serialversionuid-java` | A | medium | — | intermediate | `java-oop` | `oop-principles` |
| 237 | `shallow-vs-deep-copy-java` | B | medium | — | intermediate | `java-oop` | `oop-principles` |
| 238 | `this-vs-super-keyword-java` | B | medium | — | intermediate | `java-oop` | `oop-principles` |
| 239 | `gc-algorithms-comparison` | B | medium | — | intermediate | `jvm-internals` | `garbage-collection` |
| 240 | `gc-tuning-gclog-analysis` | A | medium | — | intermediate | `jvm-internals` | `garbage-collection` |
| 241 | `jvm-startup-optimization-virtual-threads` | A | medium | — | intermediate | `jvm-internals` | `jvm-tuning` |
| 242 | `spring-boot-jvm-container-settings` | A | medium | — | intermediate | `jvm-internals` | `jvm-tuning` |
| 243 | `memory-leak-detection-heap-dump` | A | medium | — | intermediate | `jvm-internals` | `memory-analysis` |
| 244 | `java-profiling-async-profiler` | A | medium | — | intermediate | `jvm-internals` | `profiling-and-debugging` |
| 245 | `thread-dumps-deadlock-analysis` | A | medium | — | intermediate | `jvm-internals` | `profiling-and-debugging` |
| 246 | `annotation-processing-runtime` | D | high | — | intermediate | `jvm-internals` | `scenario-based` |
| 247 | `java-module-system-jpms` | D | high | — | intermediate | `jvm-internals` | `scenario-based` |
| 248 | `java-nio-vs-traditional-io` | B | medium | — | intermediate | `jvm-internals` | `scenario-based` |
| 249 | `java-reflection-performance` | D | high | — | intermediate | `jvm-internals` | `scenario-based` |
