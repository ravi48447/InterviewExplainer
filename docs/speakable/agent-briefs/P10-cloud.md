# Pillar P10 — Cloud agent brief

> Phase 3a/3b agent brief generated by `scripts/build_agent_briefs.py`. Self-contained: an agent reading only this brief, the lint script `scripts/audit_speakable.py`, the codex JSONs, and the 7 golden references embedded below can refine this pillar's queue to lint-green output. Phase 3a smoke gate: draft **only the first question** in `content/_audits/agent-queues/P10-queue.csv`, halt for human review. (Per the SPEAKABLE-PHASE-3A-PROMPT.md §1.5 + §7.4.)
...
- **Number of questions in scope** (excludes 7 goldens + 30 priority_handcraft + already-approved): **53**
- **Question list:** see `content/_audits/agent-queues/P10-queue.csv` (columns: slug, archetype, confidence, importance, difficulty, module, topic, file).
...
|---:|---|---|---|---|---|
| 1 | `core-gcp-services-java-backend-developer` | A | medium | — | `gcp/gcp-core-services` |
| 2 | `gcp-cloud-storage-java-application` | A | medium | — | `gcp/gcp-storage-and-data` |
| 3 | `sqs-dlq-retry-patterns` | A | medium | — | `aws-cloud/aws-messaging` |
| 4 | `ec2-vs-ecs-vs-eks-vs-fargate-vs-lambda` | B | high | — | `aws-cloud/comparisons` |
| 5 | `rds-vs-aurora-vs-dynamodb` | B | high | — | `aws-cloud/comparisons` |
| 6 | `sqs-vs-sns-vs-eventbridge-vs-kinesis` | B | high | — | `aws-cloud/comparisons` |
| 7 | `ecs-task-definition-deep-dive` | A | medium | — | `aws-cloud/ecs-and-fargate` |
| 8 | `iam-role-vs-user-best-practices` | B | medium | — | `aws-cloud/iam-and-security` |
| 9 | `rds-connection-pooling-hikaricp-rds-proxy` | A | medium | — | `aws-cloud/rds-with-spring` |
| 10 | `s3-storage-classes-lifecycle-cost-optimization` | C | high | — | `aws-cloud/s3-storage` |
| 11 | `aws-bill-doubled-overnight-debug` | D | high | — | `aws-cloud/scenario-based` |
| 12 | `ec2-instance-cant-reach-rds-debug` | D | high | — | `aws-cloud/scenario-based` |
| 13 | `lambda-java-cold-start-mitigation` | A | medium | — | `aws-cloud/serverless` |
| 14 | `azure-api-management-spring-boot-microservices` | A | medium | — | `azure/azure-api-and-observability` |
| 15 | `azure-application-insights-spring-boot` | A | medium | — | `azure/azure-api-and-observability` |
| 16 | `azure-container-registry-aks-pipeline` | A | medium | — | `azure/azure-compute-and-deployment` |
| 17 | `azure-functions-java-serverless` | A | medium | — | `azure/azure-compute-and-deployment` |
| 18 | `azure-spring-apps-deployment` | A | medium | — | `azure/azure-compute-and-deployment` |
| 19 | `azure-core-services-java-backend` | A | medium | — | `azure/azure-core-services` |
| 20 | `azure-service-bus-vs-event-hub-java` | B | medium | — | `azure/azure-messaging` |
| 21 | `azure-active-directory-spring-security` | A | medium | — | `azure/azure-security-and-iam` |
| 22 | `azure-key-vault-spring-boot` | A | medium | — | `azure/azure-security-and-iam` |
| 23 | `azure-managed-identity-passwordless` | A | medium | — | `azure/azure-security-and-iam` |
| 24 | `azure-blob-storage-spring-boot` | A | medium | — | `azure/azure-storage-and-data` |
| 25 | `azure-sql-vs-cosmos-db-java` | B | medium | — | `azure/azure-storage-and-data` |
...
```jsonc
{
  ...
  "pillar": "P10",  // exactly this pillar code
...
_Topics in scope (codex `topic_id`s touched by this pillar's queue): 0._
...
_No codex examples registered for this pillar's topics yet — use the per-pillar standard examples in the register slice above._
...
- **Never** cross pillar boundaries. This brief is scoped to P10 only.
...
All 53 questions in scope, sorted by importance, then difficulty, then slug. Phase 3b iterates this list; Phase 3a smoke targets row 1.

| # | slug | archetype | confidence | importance | difficulty | module | topic |
|---:|---|---|---|---|---|---|---|
| 1 | `core-gcp-services-java-backend-developer` | A | medium | — | easy | `gcp` | `gcp-core-services` |
| 2 | `gcp-cloud-storage-java-application` | A | medium | — | easy | `gcp` | `gcp-storage-and-data` |
| 3 | `sqs-dlq-retry-patterns` | A | medium | — | medium | `aws-cloud` | `aws-messaging` |
| 4 | `ec2-vs-ecs-vs-eks-vs-fargate-vs-lambda` | B | high | — | medium | `aws-cloud` | `comparisons` |
| 5 | `rds-vs-aurora-vs-dynamodb` | B | high | — | medium | `aws-cloud` | `comparisons` |
| 6 | `sqs-vs-sns-vs-eventbridge-vs-kinesis` | B | high | — | medium | `aws-cloud` | `comparisons` |
| 7 | `ecs-task-definition-deep-dive` | A | medium | — | medium | `aws-cloud` | `ecs-and-fargate` |
| 8 | `iam-role-vs-user-best-practices` | B | medium | — | medium | `aws-cloud` | `iam-and-security` |
| 9 | `rds-connection-pooling-hikaricp-rds-proxy` | A | medium | — | medium | `aws-cloud` | `rds-with-spring` |
| 10 | `s3-storage-classes-lifecycle-cost-optimization` | C | high | — | medium | `aws-cloud` | `s3-storage` |
| 11 | `aws-bill-doubled-overnight-debug` | D | high | — | medium | `aws-cloud` | `scenario-based` |
| 12 | `ec2-instance-cant-reach-rds-debug` | D | high | — | medium | `aws-cloud` | `scenario-based` |
| 13 | `lambda-java-cold-start-mitigation` | A | medium | — | medium | `aws-cloud` | `serverless` |
| 14 | `azure-api-management-spring-boot-microservices` | A | medium | — | medium | `azure` | `azure-api-and-observability` |
| 15 | `azure-application-insights-spring-boot` | A | medium | — | medium | `azure` | `azure-api-and-observability` |
| 16 | `azure-container-registry-aks-pipeline` | A | medium | — | medium | `azure` | `azure-compute-and-deployment` |
| 17 | `azure-functions-java-serverless` | A | medium | — | medium | `azure` | `azure-compute-and-deployment` |
| 18 | `azure-spring-apps-deployment` | A | medium | — | medium | `azure` | `azure-compute-and-deployment` |
| 19 | `azure-core-services-java-backend` | A | medium | — | medium | `azure` | `azure-core-services` |
| 20 | `azure-service-bus-vs-event-hub-java` | B | medium | — | medium | `azure` | `azure-messaging` |
| 21 | `azure-active-directory-spring-security` | A | medium | — | medium | `azure` | `azure-security-and-iam` |
| 22 | `azure-key-vault-spring-boot` | A | medium | — | medium | `azure` | `azure-security-and-iam` |
| 23 | `azure-managed-identity-passwordless` | A | medium | — | medium | `azure` | `azure-security-and-iam` |
| 24 | `azure-blob-storage-spring-boot` | A | medium | — | medium | `azure` | `azure-storage-and-data` |
| 25 | `azure-sql-vs-cosmos-db-java` | B | medium | — | medium | `azure` | `azure-storage-and-data` |
| 26 | `12-factor-app-methodology-modern-cloud-native` | A | medium | — | medium | `cloud-native` | `12-factor-app` |
| 27 | `essential-cloud-design-patterns-java` | A | medium | — | medium | `cloud-native` | `cloud-design-patterns` |
| 28 | `containers-vs-vms-vs-serverless-and-orchestrator-choice` | B | high | — | medium | `cloud-native` | `comparisons` |
| 29 | `cloud-cost-optimization-finops-java-backend-40-percent` | A | medium | — | medium | `cloud-native` | `cost-optimization` |
| 30 | `deployment-strategies-rolling-blue-green-canary-progressive` | A | medium | — | medium | `cloud-native` | `deployment-strategies` |
| 31 | `disaster-recovery-rpo-rto-strategies-java-services` | A | medium | — | medium | `cloud-native` | `disaster-recovery` |
| 32 | `deploy-spring-boot-app-cloud-run` | A | medium | — | medium | `gcp` | `gcp-compute-and-deployment` |
| 33 | `gke-vs-cloud-run-java-apps` | B | medium | — | medium | `gcp` | `gcp-compute-and-deployment` |
| 34 | `bigquery-java-query` | A | medium | — | medium | `gcp` | `gcp-core-services` |
| 35 | `cloud-spanner-vs-cloud-sql` | E | high | — | medium | `gcp` | `gcp-core-services` |
| 36 | `google-cloud-pubsub-with-spring` | A | medium | — | medium | `gcp` | `gcp-messaging` |
| 37 | `monitor-java-applications-gcp-cloud-monitoring` | A | medium | — | medium | `gcp` | `gcp-observability` |
| 38 | `gcp-secret-manager-spring-boot` | A | medium | — | medium | `gcp` | `gcp-security-and-iam` |
| 39 | `multi-region-architecture-active-active-active-passive-tradeoffs` | B | medium | — | hard | `cloud-native` | `multi-region-architecture` |
| 40 | `cloud-bill-reduction-500k-month-40-percent-slo-safe` | D | high | — | hard | `cloud-native` | `scenario-based` |
| 41 | `gcp-iam-authentication-spring-boot` | A | medium | — | hard | `gcp` | `gcp-security-and-iam` |
| 42 | `auto-scaling-groups-how-they-work` | A | medium | — | intermediate | `aws-cloud` | `aws-core-services` |
| 43 | `aws-codepipeline-codebuild-deployment` | A | medium | — | intermediate | `aws-cloud` | `aws-core-services` |
| 44 | `cloudwatch-metrics-alarms-spring-boot` | A | medium | — | intermediate | `aws-cloud` | `aws-core-services` |
| 45 | `core-aws-services-overview` | A | medium | — | intermediate | `aws-cloud` | `aws-core-services` |
| 46 | `vpc-fundamentals-java-developers` | A | medium | — | intermediate | `aws-cloud` | `aws-core-services` |
| 47 | `sqs-sns-eventbridge-comparison` | B | medium | — | intermediate | `aws-cloud` | `aws-messaging` |
| 48 | `deploy-spring-boot-ecs-fargate` | A | medium | — | intermediate | `aws-cloud` | `ecs-and-fargate` |
| 49 | `iam-roles-least-privilege` | A | medium | — | intermediate | `aws-cloud` | `iam-and-security` |
| 50 | `secrets-manager-vs-parameter-store` | B | medium | — | intermediate | `aws-cloud` | `iam-and-security` |
| 51 | `rds-aurora-dynamodb-comparison` | B | medium | — | intermediate | `aws-cloud` | `rds-with-spring` |
| 52 | `s3-integration-spring-boot` | A | medium | — | intermediate | `aws-cloud` | `s3-storage` |
| 53 | `lambda-spring-cloud-function` | A | medium | — | intermediate | `aws-cloud` | `serverless` |
