# Pillar P07 — Security agent brief

> Phase 3a/3b agent brief generated by `scripts/build_agent_briefs.py`. Self-contained: an agent reading only this brief, the lint script `scripts/audit_speakable.py`, the codex JSONs, and the 7 golden references embedded below can refine this pillar's queue to lint-green output. Phase 3a smoke gate: draft **only the first question** in `content/_audits/agent-queues/P07-queue.csv`, halt for human review. (Per the SPEAKABLE-PHASE-3A-PROMPT.md §1.5 + §7.4.)
...
- **Number of questions in scope** (excludes 7 goldens + 30 priority_handcraft + already-approved): **10**
- **Question list:** see `content/_audits/agent-queues/P07-queue.csv` (columns: slug, archetype, confidence, importance, difficulty, module, topic, file).
...
|---:|---|---|---|---|---|
| 1 | `sast-vs-dast-vs-iast-vs-sca-security-scanning-comparison` | B | high | — | `application-security/comparisons` |
| 2 | `compliance-soc2-pci-hipaa-gdpr-java-engineering` | A | medium | — | `application-security/compliance` |
| 3 | `encryption-at-rest-in-transit-key-management-java` | A | medium | — | `application-security/encryption` |
| 4 | `owasp-top-10-2021-java-spring-mitigations` | A | medium | — | `application-security/owasp-top-10` |
| 5 | `secrets-management-vault-aws-secrets-kubernetes` | A | medium | — | `application-security/secrets-management` |
| 6 | `secure-coding-practices-java-spring-boot` | A | medium | — | `application-security/secure-coding` |
| 7 | `security-testing-sast-dast-sca-iast-pentest-java` | A | medium | — | `application-security/security-testing` |
| 8 | `vulnerability-scanning-cve-management-java` | A | medium | — | `application-security/vulnerability-scanning` |
| 9 | `production-aws-credentials-leaked-public-github-incident-response` | D | high | — | `application-security/scenario-based` |
| 10 | `security-architecture-zero-trust-defense-in-depth-java` | A | medium | — | `application-security/security-architecture` |
...
```jsonc
{
  ...
  "pillar": "P07",  // exactly this pillar code
...
- **Never** cross pillar boundaries. This brief is scoped to P07 only.
...
All 10 questions in scope, sorted by importance, then difficulty, then slug. Phase 3b iterates this list; Phase 3a smoke targets row 1.

| # | slug | archetype | confidence | importance | difficulty | module | topic |
|---:|---|---|---|---|---|---|---|
| 1 | `sast-vs-dast-vs-iast-vs-sca-security-scanning-comparison` | B | high | — | medium | `application-security` | `comparisons` |
| 2 | `compliance-soc2-pci-hipaa-gdpr-java-engineering` | A | medium | — | medium | `application-security` | `compliance` |
| 3 | `encryption-at-rest-in-transit-key-management-java` | A | medium | — | medium | `application-security` | `encryption` |
| 4 | `owasp-top-10-2021-java-spring-mitigations` | A | medium | — | medium | `application-security` | `owasp-top-10` |
| 5 | `secrets-management-vault-aws-secrets-kubernetes` | A | medium | — | medium | `application-security` | `secrets-management` |
| 6 | `secure-coding-practices-java-spring-boot` | A | medium | — | medium | `application-security` | `secure-coding` |
| 7 | `security-testing-sast-dast-sca-iast-pentest-java` | A | medium | — | medium | `application-security` | `security-testing` |
| 8 | `vulnerability-scanning-cve-management-java` | A | medium | — | medium | `application-security` | `vulnerability-scanning` |
| 9 | `production-aws-credentials-leaked-public-github-incident-response` | D | high | — | hard | `application-security` | `scenario-based` |
| 10 | `security-architecture-zero-trust-defense-in-depth-java` | A | medium | — | hard | `application-security` | `security-architecture` |
