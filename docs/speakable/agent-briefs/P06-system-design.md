# Pillar P06 — System Design agent brief

> Phase 3a/3b agent brief generated by `scripts/build_agent_briefs.py`. Self-contained: an agent reading only this brief, the lint script `scripts/audit_speakable.py`, the codex JSONs, and the 7 golden references embedded below can refine this pillar's queue to lint-green output. Phase 3a smoke gate: draft **only the first question** in `content/_audits/agent-queues/P06-queue.csv`, halt for human review. (Per the SPEAKABLE-PHASE-3A-PROMPT.md §1.5 + §7.4.)
...
- **Number of questions in scope** (excludes 7 goldens + 30 priority_handcraft + already-approved): **34**
- **Question list:** see `content/_audits/agent-queues/P06-queue.csv` (columns: slug, archetype, confidence, importance, difficulty, module, topic, file).
...
|---:|---|---|---|---|---|
| 1 | `oo-design-with-solid-and-composition` | F | high | — | `low-level-design/lld-fundamentals` |
| 2 | `design-parking-lot-system` | F | high | — | `low-level-design/parking-lot` |
| 3 | `design-vending-machine` | F | high | — | `low-level-design/vending-machine` |
| 4 | `cdn-edge-caching` | F | high | — | `system-design/caching-at-scale` |
| 5 | `design-distributed-cache` | F | high | — | `system-design/caching-at-scale` |
| 6 | `design-in-memory-kv-store-ttl-java` | F | high | — | `system-design/caching-at-scale` |
| 7 | `design-thread-safe-lru-cache-java` | F | high | — | `system-design/caching-at-scale` |
| 8 | `cap-theorem-trade-offs` | F | high | — | `system-design/cap-theorem` |
| 9 | `back-of-envelope-estimation` | F | high | — | `system-design/capacity-planning` |
| 10 | `database-replication-strategies` | F | high | — | `system-design/database-design-at-scale` |
| 11 | `api-gateway-pattern` | F | high | — | `system-design/design-fundamentals` |
| 12 | `consistent-hashing` | F | high | — | `system-design/design-fundamentals` |
| 13 | `design-event-sourcing-audit-log` | F | high | — | `system-design/event-driven-design` |
| 14 | `design-pubsub-event-bus-java` | F | high | — | `system-design/event-driven-design` |
| 15 | `message-queues-vs-event-streams` | F | high | — | `system-design/event-driven-design` |
| 16 | `design-retry-exponential-backoff-java` | F | high | — | `system-design/high-availability` |
| 17 | `load-balancing-strategies` | F | high | — | `system-design/load-balancing` |
| 18 | `horizontal-vs-vertical-scaling` | F | high | — | `system-design/scalability` |
| 19 | `design-connection-pool-manager-java` | F | high | — | `system-design/scenario-based` |
| 20 | `design-job-queue-system` | F | high | — | `system-design/scenario-based` |
| 21 | `design-rate-limiter-component-java` | F | high | — | `system-design/scenario-based` |
| 22 | `design-read-write-separation-cqrs` | F | high | — | `system-design/scenario-based` |
| 23 | `design-task-scheduler-job-queue-java` | F | high | — | `system-design/scenario-based` |
| 24 | `design-chat-messaging-system` | F | high | — | `system-design-cases/chat-system` |
| 25 | `design-notification-service` | F | high | — | `system-design-cases/notification-service` |
...
```jsonc
{
  ...
  "pillar": "P06",  // exactly this pillar code
...
_Topics in scope (codex `topic_id`s touched by this pillar's queue): 4._
...
[
  {
    "topic_id": "event-driven-design",
    "example": "OrderPlaced event consumed by Inventory + Email + Analytics",
    "use_when": "showing fan-out without coupling",
    "source": "agent-seeded"
  },
  {
    "topic_id": "cap-theorem-and-tradeoffs",
    "example": "DynamoDB favours availability (AP); Spanner favours consistency (CP)",
    "use_when": "the canonical AP vs CP pair",
    "source": "agent-seeded"
  },
  {
  ...
  {
    "topic_id": "rate-limiter-design",
    "example": "1M req/s, 1KB per token-bucket entry → 1GB hot state in Redis",
    "use_when": "the canonical numerical capacity for the limiter itself",
    "source": "agent-seeded"
  }
]
```
...
- **Never** cross pillar boundaries. This brief is scoped to P06 only.
...
All 34 questions in scope, sorted by importance, then difficulty, then slug. Phase 3b iterates this list; Phase 3a smoke targets row 1.

| # | slug | archetype | confidence | importance | difficulty | module | topic |
|---:|---|---|---|---|---|---|---|
| 1 | `oo-design-with-solid-and-composition` | F | high | — | intermediate | `low-level-design` | `lld-fundamentals` |
| 2 | `design-parking-lot-system` | F | high | — | intermediate | `low-level-design` | `parking-lot` |
| 3 | `design-vending-machine` | F | high | — | intermediate | `low-level-design` | `vending-machine` |
| 4 | `cdn-edge-caching` | F | high | — | intermediate | `system-design` | `caching-at-scale` |
| 5 | `design-distributed-cache` | F | high | — | intermediate | `system-design` | `caching-at-scale` |
| 6 | `design-in-memory-kv-store-ttl-java` | F | high | — | intermediate | `system-design` | `caching-at-scale` |
| 7 | `design-thread-safe-lru-cache-java` | F | high | — | intermediate | `system-design` | `caching-at-scale` |
| 8 | `cap-theorem-trade-offs` | F | high | — | intermediate | `system-design` | `cap-theorem` |
| 9 | `back-of-envelope-estimation` | F | high | — | intermediate | `system-design` | `capacity-planning` |
| 10 | `database-replication-strategies` | F | high | — | intermediate | `system-design` | `database-design-at-scale` |
| 11 | `api-gateway-pattern` | F | high | — | intermediate | `system-design` | `design-fundamentals` |
| 12 | `consistent-hashing` | F | high | — | intermediate | `system-design` | `design-fundamentals` |
| 13 | `design-event-sourcing-audit-log` | F | high | — | intermediate | `system-design` | `event-driven-design` |
| 14 | `design-pubsub-event-bus-java` | F | high | — | intermediate | `system-design` | `event-driven-design` |
| 15 | `message-queues-vs-event-streams` | F | high | — | intermediate | `system-design` | `event-driven-design` |
| 16 | `design-retry-exponential-backoff-java` | F | high | — | intermediate | `system-design` | `high-availability` |
| 17 | `load-balancing-strategies` | F | high | — | intermediate | `system-design` | `load-balancing` |
| 18 | `horizontal-vs-vertical-scaling` | F | high | — | intermediate | `system-design` | `scalability` |
| 19 | `design-connection-pool-manager-java` | F | high | — | intermediate | `system-design` | `scenario-based` |
| 20 | `design-job-queue-system` | F | high | — | intermediate | `system-design` | `scenario-based` |
| 21 | `design-rate-limiter-component-java` | F | high | — | intermediate | `system-design` | `scenario-based` |
| 22 | `design-read-write-separation-cqrs` | F | high | — | intermediate | `system-design` | `scenario-based` |
| 23 | `design-task-scheduler-job-queue-java` | F | high | — | intermediate | `system-design` | `scenario-based` |
| 24 | `design-chat-messaging-system` | F | high | — | intermediate | `system-design-cases` | `chat-system` |
| 25 | `design-notification-service` | F | high | — | intermediate | `system-design-cases` | `notification-service` |
| 26 | `design-api-idempotency-payments` | F | high | — | intermediate | `system-design-cases` | `payment-system` |
| 27 | `design-ecommerce-order-management` | F | high | — | intermediate | `system-design-cases` | `payment-system` |
| 28 | `design-rate-limiter` | F | high | — | intermediate | `system-design-cases` | `rate-limiter` |
| 29 | `design-file-storage-service` | F | high | — | intermediate | `system-design-cases` | `scenario-based` |
| 30 | `design-leaderboard-system` | F | high | — | intermediate | `system-design-cases` | `scenario-based` |
| 31 | `design-ride-sharing-service` | F | high | — | intermediate | `system-design-cases` | `scenario-based` |
| 32 | `design-video-streaming-platform` | F | high | — | intermediate | `system-design-cases` | `scenario-based` |
| 33 | `design-search-autocomplete` | F | high | — | intermediate | `system-design-cases` | `search-autocomplete` |
| 34 | `design-social-media-feed` | F | high | — | intermediate | `system-design-cases` | `social-media-feed` |
