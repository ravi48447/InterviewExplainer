# Pillar P08 — Testing & Quality agent brief

> Phase 3a/3b agent brief generated by `scripts/build_agent_briefs.py`. Self-contained: an agent reading only this brief, the lint script `scripts/audit_speakable.py`, the codex JSONs, and the 7 golden references embedded below can refine this pillar's queue to lint-green output. Phase 3a smoke gate: draft **only the first question** in `content/_audits/agent-queues/P08-queue.csv`, halt for human review. (Per the SPEAKABLE-PHASE-3A-PROMPT.md §1.5 + §7.4.)

---

## Identity & scope

- **Pillar:** P08 / Testing & Quality
- **Pillar register:** see slice below.
- **Number of questions in scope** (excludes 7 goldens + 30 priority_handcraft + already-approved): **29**
- **Question list:** see `content/_audits/agent-queues/P08-queue.csv` (columns: slug, archetype, confidence, importance, difficulty, module, topic, file).
...
|---:|---|---|---|---|---|
| 1 | `chaos-engineering-java-microservices-game-days` | A | medium | — | `unit-testing/chaos-testing` |
| 2 | `test-pyramid-vs-trophy-vs-diamond-testcontainers-vs-mocks-contract-vs-e2e` | B | high | — | `unit-testing/comparisons` |
| 3 | `consumer-driven-contract-testing-pact-spring-cloud` | A | medium | — | `unit-testing/contract-testing` |
| 4 | `mockito-mock-spy-mockbean` | B | medium | — | `unit-testing/mocking-with-mockito` |
| 5 | `performance-load-stress-soak-spike-testing-java` | A | medium | — | `unit-testing/performance-testing` |
| 6 | `mockmvc-controller-testing` | A | medium | — | `unit-testing/spring-boot-testing` |
| 7 | `spring-test-slices-comparison` | B | medium | — | `unit-testing/spring-boot-testing` |
| 8 | `springboottest-and-slice-variants` | A | medium | — | `unit-testing/spring-boot-testing` |
| 9 | `tdd-practices-red-green-refactor-java-spring` | A | medium | — | `unit-testing/tdd-practices` |
| 10 | `test-automation-strategy-pyramid-flakiness-java` | A | medium | — | `unit-testing/test-automation` |
| 11 | `datajpatest-with-testcontainers` | A | medium | — | `unit-testing/testcontainers` |
| 12 | `testcontainers-real-database-integration` | A | medium | — | `unit-testing/testcontainers` |
| 13 | `modern-test-pyramid-diamond-strategies-java` | B | medium | — | `unit-testing/testing-strategies` |
| 14 | `parameterized-test-method-source` | A | medium | — | `unit-testing/unit-testing-basics` |
| 15 | `tdd-red-green-refactor` | A | medium | — | `unit-testing/unit-testing-basics` |
| 16 | `unit-vs-integration-vs-e2e-testing` | B | medium | — | `unit-testing/unit-testing-basics` |
| 17 | `testing-kafka-embedded-kafka` | A | medium | — | `unit-testing/integration-testing` |
| 18 | `testing-spring-security` | A | medium | — | `unit-testing/spring-boot-testing` |
| 19 | `testing-async-completablefuture` | A | medium | — | `unit-testing/unit-testing-advanced` |
| 20 | `integration-testing-spring-boot` | A | medium | — | `unit-testing/integration-testing` |
| 21 | `mockito-mock-spy-verify-argumentcaptor` | A | medium | — | `unit-testing/mocking-with-mockito` |
| 22 | `mockmvc-testing-controllers` | A | medium | — | `unit-testing/spring-boot-testing` |
| 23 | `testcontainers-spring-boot` | A | medium | — | `unit-testing/testcontainers` |
| 24 | `code-coverage-jacoco-spring-boot` | A | medium | — | `unit-testing/unit-testing-advanced` |
| 25 | `junit5-assertions-assertj` | A | medium | — | `unit-testing/unit-testing-basics` |
...
```jsonc
{
  ...
  "pillar": "P08",  // exactly this pillar code
...
- **Never** cross pillar boundaries. This brief is scoped to P08 only.
...
All 29 questions in scope, sorted by importance, then difficulty, then slug. Phase 3b iterates this list; Phase 3a smoke targets row 1.

| # | slug | archetype | confidence | importance | difficulty | module | topic |
|---:|---|---|---|---|---|---|---|
| 1 | `chaos-engineering-java-microservices-game-days` | A | medium | — | medium | `unit-testing` | `chaos-testing` |
| 2 | `test-pyramid-vs-trophy-vs-diamond-testcontainers-vs-mocks-contract-vs-e2e` | B | high | — | medium | `unit-testing` | `comparisons` |
| 3 | `consumer-driven-contract-testing-pact-spring-cloud` | A | medium | — | medium | `unit-testing` | `contract-testing` |
| 4 | `mockito-mock-spy-mockbean` | B | medium | — | medium | `unit-testing` | `mocking-with-mockito` |
| 5 | `performance-load-stress-soak-spike-testing-java` | A | medium | — | medium | `unit-testing` | `performance-testing` |
| 6 | `mockmvc-controller-testing` | A | medium | — | medium | `unit-testing` | `spring-boot-testing` |
| 7 | `spring-test-slices-comparison` | B | medium | — | medium | `unit-testing` | `spring-boot-testing` |
| 8 | `springboottest-and-slice-variants` | A | medium | — | medium | `unit-testing` | `spring-boot-testing` |
| 9 | `tdd-practices-red-green-refactor-java-spring` | A | medium | — | medium | `unit-testing` | `tdd-practices` |
| 10 | `test-automation-strategy-pyramid-flakiness-java` | A | medium | — | medium | `unit-testing` | `test-automation` |
| 11 | `datajpatest-with-testcontainers` | A | medium | — | medium | `unit-testing` | `testcontainers` |
| 12 | `testcontainers-real-database-integration` | A | medium | — | medium | `unit-testing` | `testcontainers` |
| 13 | `modern-test-pyramid-diamond-strategies-java` | B | medium | — | medium | `unit-testing` | `testing-strategies` |
| 14 | `parameterized-test-method-source` | A | medium | — | medium | `unit-testing` | `unit-testing-basics` |
| 15 | `tdd-red-green-refactor` | A | medium | — | medium | `unit-testing` | `unit-testing-basics` |
| 16 | `unit-vs-integration-vs-e2e-testing` | B | medium | — | medium | `unit-testing` | `unit-testing-basics` |
| 17 | `testing-kafka-embedded-kafka` | A | medium | — | hard | `unit-testing` | `integration-testing` |
| 18 | `testing-spring-security` | A | medium | — | hard | `unit-testing` | `spring-boot-testing` |
| 19 | `testing-async-completablefuture` | A | medium | — | hard | `unit-testing` | `unit-testing-advanced` |
| 20 | `integration-testing-spring-boot` | A | medium | — | intermediate | `unit-testing` | `integration-testing` |
| 21 | `mockito-mock-spy-verify-argumentcaptor` | A | medium | — | intermediate | `unit-testing` | `mocking-with-mockito` |
| 22 | `mockmvc-testing-controllers` | A | medium | — | intermediate | `unit-testing` | `spring-boot-testing` |
| 23 | `testcontainers-spring-boot` | A | medium | — | intermediate | `unit-testing` | `testcontainers` |
| 24 | `code-coverage-jacoco-spring-boot` | A | medium | — | intermediate | `unit-testing` | `unit-testing-advanced` |
| 25 | `junit5-assertions-assertj` | A | medium | — | intermediate | `unit-testing` | `unit-testing-basics` |
| 26 | `parameterized-tests-junit5` | A | medium | — | intermediate | `unit-testing` | `unit-testing-basics` |
| 27 | `test-driven-development-tdd-java` | A | medium | — | intermediate | `unit-testing` | `unit-testing-basics` |
| 28 | `testing-exceptions-junit5` | A | medium | — | intermediate | `unit-testing` | `unit-testing-basics` |
| 29 | `unit-testing-best-practices-java` | A | medium | — | intermediate | `unit-testing` | `unit-testing-basics` |
