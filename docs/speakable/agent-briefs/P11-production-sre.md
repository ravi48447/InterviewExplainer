# Pillar P11 — Production agent brief

> Phase 3a/3b agent brief generated by `scripts/build_agent_briefs.py`. Self-contained: an agent reading only this brief, the lint script `scripts/audit_speakable.py`, the codex JSONs, and the 7 golden references embedded below can refine this pillar's queue to lint-green output. Phase 3a smoke gate: draft **only the first question** in `content/_audits/agent-queues/P11-queue.csv`, halt for human review. (Per the SPEAKABLE-PHASE-3A-PROMPT.md §1.5 + §7.4.)

---

## Identity & scope

- **Pillar:** P11 / Production
- **Pillar register:** see slice below.
- **Number of questions in scope** (excludes 7 goldens + 30 priority_handcraft + already-approved): **46**
- **Question list:** see `content/_audits/agent-queues/P11-queue.csv` (columns: slug, archetype, confidence, importance, difficulty, module, topic, file).
...
|---:|---|---|---|---|---|
| 1 | `log-levels-when-to-use-each` | D | medium | — | `observability/structured-logging` |
| 2 | `four-golden-signals-red-use-methodologies` | A | medium | — | `observability/apm-tools` |
| 3 | `opentelemetry-fundamentals-spring-boot` | A | medium | — | `observability/apm-tools` |
| 4 | `datadog-vs-new-relic-vs-dynatrace-vs-grafana` | B | high | — | `observability/comparisons` |
| 5 | `prometheus-vs-cloudwatch-vs-datadog-metrics` | B | high | — | `observability/comparisons` |
| 6 | `kubernetes-log-aggregation` | A | medium | — | `observability/distributed-log-aggregation` |
| 7 | `finding-missing-traces-instrumentation-gap` | D | high | — | `observability/scenario-based` |
| 8 | `p99-latency-spike-debug-walkthrough` | D | high | — | `observability/scenario-based` |
| 9 | `slf4j-logback-structured-logging-spring-boot` | A | medium | — | `observability/structured-logging` |
| 10 | `incident-severity-levels-slo-error-budget` | D | high | — | `production-sre/incident-management` |
| 11 | `incident-response-process-icm-roles` | D | high | — | `production-sre/incident-response` |
| 12 | `on-call-rotation-best-practices` | G | high | — | `production-sre/on-call` |
| 13 | `blameless-postmortem-template-process` | D | high | — | `production-sre/postmortems` |
| 14 | `root-cause-analysis-techniques-systems-thinking` | D | high | — | `production-sre/root-cause-analysis` |
| 15 | `alerting-strategy-slos-slas-error-budgets-java-services` | A | medium | — | `observability/alerting` |
| 16 | `log-aggregation-elk-stack-elasticsearch-logstash-kibana` | A | medium | — | `observability/distributed-log-aggregation` |
| 17 | `distributed-tracing-spring-cloud-sleuth-zipkin-jaeger` | A | medium | — | `observability/distributed-tracing` |
| 18 | `opentelemetry-vs-micrometer-vs-sleuth-comparison` | B | medium | — | `observability/distributed-tracing` |
| 19 | `production-debugging-distributed-traces-latency-bottlenecks` | A | medium | — | `observability/distributed-tracing` |
| 20 | `health-checks-vs-readiness-checks-actuator-health` | B | medium | — | `observability/health-checks-and-probes` |
| 21 | `micrometer-counters-timers-gauges-spring-boot` | A | medium | — | `observability/metrics-and-micrometer` |
| 22 | `three-pillars-observability-metrics-logs-traces` | A | medium | — | `observability/metrics-and-micrometer` |
| 23 | `grafana-dashboards-spring-boot-service-health` | A | medium | — | `observability/prometheus-and-grafana` |
| 24 | `spring-boot-actuator-prometheus-metrics-setup` | A | medium | — | `observability/prometheus-and-grafana` |
| 25 | `structured-logging-logback-correlation-ids` | A | medium | — | `observability/structured-logging` |
...
```jsonc
{
  ...
  "pillar": "P11",  // exactly this pillar code
...
[
  {
    "topic_id": "log-levels-and-structured-logging",
    "example": "{\"level\":\"INFO\",\"trace_id\":\"abc\",\"event\":\"order.created\",\"order_id\":42}",
    "use_when": "the canonical structured-log line",
    "source": "agent-seeded"
  },
  {
  ...
  {
    "topic_id": "incident-response-and-runbooks",
    "example": "P0 declared → on-call paged → commander assigned → comms branch + investigation branch",
    "use_when": "the canonical incident shape",
    "source": "agent-seeded"
  }
]
```
...
- **Never** cross pillar boundaries. This brief is scoped to P11 only.
...
All 46 questions in scope, sorted by importance, then difficulty, then slug. Phase 3b iterates this list; Phase 3a smoke targets row 1.

| # | slug | archetype | confidence | importance | difficulty | module | topic |
|---:|---|---|---|---|---|---|---|
| 1 | `log-levels-when-to-use-each` | D | medium | — | easy | `observability` | `structured-logging` |
| 2 | `four-golden-signals-red-use-methodologies` | A | medium | — | medium | `observability` | `apm-tools` |
| 3 | `opentelemetry-fundamentals-spring-boot` | A | medium | — | medium | `observability` | `apm-tools` |
| 4 | `datadog-vs-new-relic-vs-dynatrace-vs-grafana` | B | high | — | medium | `observability` | `comparisons` |
| 5 | `prometheus-vs-cloudwatch-vs-datadog-metrics` | B | high | — | medium | `observability` | `comparisons` |
| 6 | `kubernetes-log-aggregation` | A | medium | — | medium | `observability` | `distributed-log-aggregation` |
| 7 | `finding-missing-traces-instrumentation-gap` | D | high | — | medium | `observability` | `scenario-based` |
| 8 | `p99-latency-spike-debug-walkthrough` | D | high | — | medium | `observability` | `scenario-based` |
| 9 | `slf4j-logback-structured-logging-spring-boot` | A | medium | — | medium | `observability` | `structured-logging` |
| 10 | `incident-severity-levels-slo-error-budget` | D | high | — | medium | `production-sre` | `incident-management` |
| 11 | `incident-response-process-icm-roles` | D | high | — | medium | `production-sre` | `incident-response` |
| 12 | `on-call-rotation-best-practices` | G | high | — | medium | `production-sre` | `on-call` |
| 13 | `blameless-postmortem-template-process` | D | high | — | medium | `production-sre` | `postmortems` |
| 14 | `root-cause-analysis-techniques-systems-thinking` | D | high | — | medium | `production-sre` | `root-cause-analysis` |
| 15 | `alerting-strategy-slos-slas-error-budgets-java-services` | A | medium | — | intermediate | `observability` | `alerting` |
| 16 | `log-aggregation-elk-stack-elasticsearch-logstash-kibana` | A | medium | — | intermediate | `observability` | `distributed-log-aggregation` |
| 17 | `distributed-tracing-spring-cloud-sleuth-zipkin-jaeger` | A | medium | — | intermediate | `observability` | `distributed-tracing` |
| 18 | `opentelemetry-vs-micrometer-vs-sleuth-comparison` | B | medium | — | intermediate | `observability` | `distributed-tracing` |
| 19 | `production-debugging-distributed-traces-latency-bottlenecks` | A | medium | — | intermediate | `observability` | `distributed-tracing` |
| 20 | `health-checks-vs-readiness-checks-actuator-health` | B | medium | — | intermediate | `observability` | `health-checks-and-probes` |
| 21 | `micrometer-counters-timers-gauges-spring-boot` | A | medium | — | intermediate | `observability` | `metrics-and-micrometer` |
| 22 | `three-pillars-observability-metrics-logs-traces` | A | medium | — | intermediate | `observability` | `metrics-and-micrometer` |
| 23 | `grafana-dashboards-spring-boot-service-health` | A | medium | — | intermediate | `observability` | `prometheus-and-grafana` |
| 24 | `spring-boot-actuator-prometheus-metrics-setup` | A | medium | — | intermediate | `observability` | `prometheus-and-grafana` |
| 25 | `structured-logging-logback-correlation-ids` | A | medium | — | intermediate | `observability` | `structured-logging` |
| 26 | `capacity-planning-backend-service` | D | high | — | intermediate | `production-sre` | `capacity-planning` |
| 27 | `chaos-engineering-what-is-it-how-to-apply` | D | high | — | intermediate | `production-sre` | `chaos-engineering` |
| 28 | `reduce-java-application-memory-footprint` | D | high | — | intermediate | `production-sre` | `memory-leaks` |
| 29 | `async-processing-improve-api-response-time-java` | D | high | — | intermediate | `production-sre` | `performance-troubleshooting` |
| 30 | `common-spring-boot-performance-anti-patterns` | D | high | — | intermediate | `production-sre` | `performance-troubleshooting` |
| 31 | `connection-pooling-improve-database-performance-java` | D | high | — | intermediate | `production-sre` | `performance-troubleshooting` |
| 32 | `diagnose-and-fix-slow-database-query-spring-boot` | D | high | — | intermediate | `production-sre` | `performance-troubleshooting` |
| 33 | `how-to-benchmark-java-code-with-jmh` | D | high | — | intermediate | `production-sre` | `performance-troubleshooting` |
| 34 | `how-to-profile-java-application-performance-bottlenecks` | D | high | — | intermediate | `production-sre` | `performance-troubleshooting` |
| 35 | `how-to-size-thread-pools-for-optimal-throughput` | D | high | — | intermediate | `production-sre` | `performance-troubleshooting` |
| 36 | `latency-vs-throughput-optimization-java` | B | medium | — | intermediate | `production-sre` | `performance-troubleshooting` |
| 37 | `optimize-json-serialization-deserialization-java` | D | high | — | intermediate | `production-sre` | `performance-troubleshooting` |
| 38 | `production-incident-runbook-and-process` | D | high | — | intermediate | `production-sre` | `runbooks` |
| 39 | `blue-green-vs-canary-deployment-difference` | B | medium | — | intermediate | `production-sre` | `scenario-based` |
| 40 | `database-schema-migrations-production-flyway-liquibase` | D | high | — | intermediate | `production-sre` | `scenario-based` |
| 41 | `what-is-cache-stampede-how-to-prevent-it` | D | high | — | intermediate | `production-sre` | `scenario-based` |
| 42 | `circuit-breaker-pattern-production-java` | D | high | — | intermediate | `production-sre` | `sre-practices` |
| 43 | `how-to-implement-feature-flag-system` | D | high | — | intermediate | `production-sre` | `sre-practices` |
| 44 | `key-health-checks-production-java-app` | D | high | — | intermediate | `production-sre` | `sre-practices` |
| 45 | `sre-vs-devops-difference` | B | medium | — | intermediate | `production-sre` | `sre-practices` |
| 46 | `zero-downtime-deployments-spring-boot` | D | high | — | intermediate | `production-sre` | `sre-practices` |
