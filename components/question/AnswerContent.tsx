        ...
        <div className="space-y-16 pb-20">
            ...
            <section className="space-y-5">
                <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-sm font-extrabold uppercase tracking-[0.2em] text-primary dark:text-primary">What the Interviewer Wants to Hear</h2>
                </div>
                <div className="p-8 rounded-[2rem] bg-primary/5 border border-default dark:border-default/10 leading-relaxed relative overflow-hidden">
            ...
            <section className="space-y-6">
                <div className="flex items-center gap-3 border-b border-white/5 pb-5">
                    ...
                    <h2 className="text-sm font-extrabold uppercase tracking-[0.2em] text-white/80">Core Concepts & Deep Dive</h2>
                </div>
            ...
            <section className="space-y-5">
                <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-sm font-extrabold uppercase tracking-[0.2em] text-warning">Important Points</h2>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {answer.interviewTips.split('•').filter(t => t.trim()).slice(0, 4).map((tip, idx) => (
                        <div key={idx} className="p-5 rounded-2xl bg-background/[0.03] border border-white/5 flex items-start gap-4 hover:border-warning dark:border-warning/20 transition-colors">
                            <span className="text-[10px] font-extrabold text-warning/60 mt-1">0{idx + 1}</span>
                ...
                <section className="space-y-5">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <h2 className="text-sm font-extrabold uppercase tracking-[0.2em] text-primary dark:text-primary">Implementation Pattern</h2>
                        </div>
                        <button
                            onClick={() => copyToClipboard(answer.codeSnippet || "")}
                            aria-label={copied ? "Code copied" : "Copy code to clipboard"}
                            className="touch-target px-4 py-2 rounded-xl glass-strong text-[9px] font-extrabold uppercase tracking-widest hover:bg-background/10 transition-colors flex items-center gap-2"
                        >
            ...
            <section className="pt-10">
                <div className="p-10 rounded-[3rem] bg-gradient-to-br from-primary/10 via-white/[0.01] to-transparent border border-white/10 relative overflow-hidden group">
                    ...
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <div>
                            <h2 className="text-xl font-extrabold uppercase tracking-tight text-white/90 italic">The Speakable Answer</h2>
                    ...
                    <div className="mt-8 flex items-center justify-between px-2">
                        <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-[10px] font-extrabold uppercase tracking-[0.2em] text-primary">Mastery Standard</span>
                        </div>
                        <button
                            aria-label="Copy speakable answer to revise list"
                            className="touch-target text-[10px] font-extrabold uppercase tracking-[0.2em] text-muted-foreground/40 hover:text-white transition-colors"
                        >
                            Copy to Revise List
                        </button>
                    </div>
