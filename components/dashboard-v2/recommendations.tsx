  ...
  if (set.items.length === 0) {
    return (
      <EmptyState
        ...
        description="No recommendations yet. Answer a few questions to get personalized picks."
      />
    );
  }
  ...
  return (
    <section className="rounded-xl border border-border bg-card p-6">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="type-display text-lg font-bold text-foreground">Recommended for you</h2>
      </div>
