          ...
          <aside className="hidden lg:flex w-[280px] shrink-0 flex-col gap-4 self-start sticky top-6">
            <div className="rounded-xl border border-border bg-background/90 backdrop-blur-sm shadow-sm overflow-hidden">
              <div className="px-4 py-3 bg-gradient-to-r from-slate-100 to-slate-50 border-b border-border">
                <Link href="/interview" className="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-secondary hover:text-[#2e64e5] transition-colors">
                    ...
                    return (
                      <Link
                        ...
                        className={`flex items-center gap-2.5 px-3 py-2.5 text-xs font-semibold rounded-lg transition-all ${
                          isActive
                            ? "bg-background text-foreground border border-blue-200 shadow-sm"
                            : "text-secondary hover:text-foreground hover:bg-background/50 border border-transparent"
                        }`}
                      >
            ...
            <div className="rounded-xl border border-emerald-200 bg-gradient-to-br from-emerald-50 to-teal-50 shadow-sm p-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-xs">
                  <span className="text-secondary">Stacks Completed</span>
                ...
                <div key={stack.slug} className="border rounded-[12px] border-border shadow-sm bg-[#f8f9fa] overflow-hidden hover:border-border hover:shadow-md transition-all">
                  <div className="flex flex-col sm:flex-row items-stretch sm:items-center">
                    <div className="flex-1 flex gap-3 items-start sm:items-center p-4 sm:px-5">
                      <div className="shrink-0 w-8 h-8 rounded-full bg-background border border-border text-slate-400 flex items-center justify-center">
                    ...
                    <div className="flex items-center gap-3 shrink-0 px-4 pb-3 sm:pb-0 sm:pr-5">
                      <div className="hidden sm:flex flex-col items-end gap-0.5">
                        ...
                        <span className="text-[12px] font-semibold text-secondary">{stack.questionCount} Qs</span>
                      </div>
                      <Link
                  ...
                  {stack.questions.length > 0 && (
                    <div className="border-t border-slate-100 bg-background px-3 sm:px-4 py-3">
