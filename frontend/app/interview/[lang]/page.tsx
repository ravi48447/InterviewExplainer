            ...
            {meta.tracks.map(track => {
              ...
              return (
                <Link
                  ...
                  className="group flex items-start gap-4 p-5 bg-background rounded-2xl border border-border hover:border-default dark:border-default hover:shadow-lg transition-all"
                >
                    ...
                    <div className="mt-3 flex gap-2">
                      {["Beginner", "Intermediate", "Advanced"].map(lvl => (
                        <Link
                          ...
                          className="text-[10px] font-bold px-2 py-1 rounded-lg bg-surface text-muted-foreground hover:bg-blue-100 dark:bg-blue-950/20 hover:text-primary dark:text-primary transition-colors"
