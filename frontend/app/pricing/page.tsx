...
export default function PricingPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-120px)] bg-slate-50/60 dark:bg-slate-950/40 px-4 py-14">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Free tier */}
          <div className="rounded-2xl border border-slate-200 bg-white dark:bg-slate-900 dark:border-slate-800 p-7 flex flex-col">
            <div className="flex items-center gap-2 mb-1">
              <BookOpen className="h-5 w-5 text-slate-400" />
              <h2 className="text-lg font-bold text-slate-900 dark:text-white">Free</h2>
            </div>
            <p className="text-sm text-slate-500 mb-5">Everything you need to read and learn.</p>
            <div className="mb-6">
            ...
            <Link
              href="/domains"
              className="mt-7 inline-flex items-center justify-center gap-1.5 px-5 py-3 rounded-lg border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 font-semibold text-sm hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors"
            >
          ...
          <div className="relative rounded-2xl border-2 border-amber-300 bg-gradient-to-b from-amber-50/80 to-white dark:from-amber-950/20 dark:to-slate-900 p-7 flex flex-col shadow-lg shadow-amber-200/40">
            <div className="absolute -top-3 left-1/2 -translate-x-1/2">
              <span className="rounded-full bg-amber-500 px-3 py-1 text-[11px] font-bold uppercase tracking-wider text-white">
                Most popular
              </span>
            </div>
            <div className="flex items-center gap-2 mb-1">
            ...
            <p className="text-sm text-slate-500 mb-5">Your personalized prep command center.</p>
            <div className="mb-6 flex items-end gap-2">
              <span className="text-4xl font-black text-slate-900 dark:text-white">{PRO_PRICE_LABEL}</span>
