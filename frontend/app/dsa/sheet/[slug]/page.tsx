...
function HeroStat({
  ...
  return (
    <div className="flex items-center gap-3 rounded-xl border border-white/[0.08] bg-background/[0.04] p-3.5 transition-colors hover:bg-background/[0.07] hover:border-blue-500 dark:border-blue-500/50 dark:border-blue-700/25">
      <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-blue-500 dark:bg-blue-800/15 shrink-0">
...
function ProblemRow({
  ...
  const RowInner = (
    <>
      ...
      <span className="flex-1 text-sm font-medium text-foreground group-hover:text-blue-700 dark:text-blue-400 capitalize truncate transition-colors">
        {title}
      </span>
      {difficulty && (
        <span
      ...
      {href && (
        <ArrowRight className="h-3.5 w-3.5 text-muted-foreground group-hover:text-blue-600 dark:text-blue-400 transition-colors" />
      )}
    </>
  );
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-surface-subtle to-background dark:from-background dark:to-background font-sans text-foreground">
      ...
      <div
        ...
        style={{
          background:
            ...
            "radial-gradient(55% 40% at 92% 18%, rgba(37,99,235,0.09) 0%, transparent 60%)," +
      ...
      <header className="relative z-10 overflow-hidden bg-hero text-white">
        ...
        <div
          className="pointer-events-none absolute inset-0"
          style={{ background: "radial-gradient(ellipse 50% 60% at 100% 110%, rgba(37,99,235,0.16) 0%, transparent 55%)" }}
          aria-hidden
        />
        <div
                ...
                <div className="text-xs text-zinc-500 dark:text-zinc-400 flex items-center gap-2 flex-wrap">
                  ...
                  {sheet.sourceUrl && (
                    <a
                      ...
                      className="inline-flex items-center gap-1 text-blue-600 dark:text-blue-300 hover:text-blue-300 dark:text-blue-300"
                    >
                      Original source
              ...
              {allSlugs.length > 0 && (
                <div className="rounded-xl border border-white/[0.08] bg-background/[0.03] p-4">
                  ...
                  <div className="h-2 bg-background/[0.08] rounded-full overflow-hidden">
                    <div
                      className="h-full bg-gradient-to-r from-blue-50 dark:from-blue-950/40 to-blue-50 dark:to-blue-950/40"
      ...
      <div className="relative z-10">
        ...
        <div
          aria-hidden
          className="pointer-events-none absolute inset-x-0 top-0 h-[300px] bg-gradient-to-b from-blue-200/25 via-blue-100/10 to-transparent"
        />
                  ...
                  >
                    <div className="flex items-center justify-between gap-3 px-5 py-3.5 border-b border-slate-100 dark:border-slate-800/60 bg-gradient-to-br from-slate-50 to-white dark:from-slate-900/40 dark:to-background dark:from-zinc-900 dark:to-zinc-950/60">
                      <h3 className="text-[15px] font-bold text-foreground capitalize flex items-center gap-2.5 tracking-tight">
                        <span className="inline-flex items-center justify-center h-7 w-7 rounded-lg bg-gradient-to-br from-blue-50 dark:from-blue-950/40 to-blue-50 dark:to-blue-950/40 text-white text-xs font-black shadow-sm shadow-blue-200">
                          {gi + 1}
                        </span>
                        {group.title}
                      </h3>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {otherSheets.map((s) => (
              ...
              >
                <div className="h-1.5 bg-gradient-to-r from-blue-50 dark:from-blue-950/40 to-blue-50 dark:to-blue-950/40" />
                <div className="p-5 flex flex-col flex-1">
                  <div className="flex items-center gap-2 text-[11px] font-bold uppercase tracking-widest text-blue-500 dark:text-blue-400 mb-2">
                    <ListChecks className="h-3.5 w-3.5" /> Study plan
                  </div>
                  <div className="text-lg font-black text-foreground group-hover:text-blue-700 dark:text-blue-400 capitalize tracking-tight transition-colors">
                    {s.replace(/-/g, " ")}
                  </div>
