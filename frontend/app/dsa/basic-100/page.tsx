...
// Fully static (SSG): this single page pre-renders at build time when the
// filesystem is available. `force-static` prevents any runtime re-render
// path — `getBasic100` reads `fs`, which does not exist on Cloudflare Workers.
