        ...
        <div className="space-y-16 pb-20">
            ...
            <section className="space-y-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {answer.interviewTips.split('•').filter(t => t.trim()).slice(0, 4).map((tip, idx) => (
                        <div key={idx} className="p-5 rounded-2xl bg-white/[0.03] border border-white/5 flex items-start gap-4 hover:border-orange-500/20 transition-colors">
                ...
                <section className="space-y-5">
                    <div className="flex items-center justify-between">
                        ...
                        <button
                            ...
                            className="px-4 py-2 rounded-xl glass-strong text-[9px] font-black uppercase tracking-widest hover:bg-white/10 transition-colors flex items-center gap-2"
                        >
                    ...
                    <div className="relative group">
                        <pre className="p-10 rounded-[2.5rem] bg-black/40 border border-white/5 overflow-x-auto text-[14px] font-mono text-cyan-500/80 leading-relaxed shadow-inner">
            ...
            <section className="pt-10">
                <div className="p-10 rounded-[3rem] bg-gradient-to-br from-primary/10 via-white/[0.01] to-transparent border border-white/10 relative overflow-hidden group">
                    ...
                    <div className="p-8 rounded-[2rem] bg-black/40 backdrop-blur-2xl border border-white/5 font-medium text-lg leading-relaxed text-foreground/90 italic shadow-inner">
