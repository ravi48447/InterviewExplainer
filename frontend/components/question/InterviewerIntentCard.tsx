  ...
  return (
    <section className="mb-6">
      <div className="rounded-xl border border-violet-200 dark:border-violet-500/20 bg-violet-50/40 dark:bg-violet-500/10 overflow-hidden">
        <div className="flex items-center gap-2 px-5 py-2.5 border-b border-violet-200 dark:border-violet-500/20 bg-violet-50 dark:bg-violet-500/10">
          <Target className="h-3.5 w-3.5 text-violet-500 dark:text-violet-400" />
          <span className="text-[11px] font-bold uppercase tracking-widest text-violet-700 dark:text-violet-400">
            Coaching Notes
          </span>
        </div>
        <div className="px-5 py-4 divide-y divide-violet-100">
          {testing && (
            <div className="flex gap-3 py-3 first:pt-0 last:pb-0">
              ...
              <div>
                <p className="text-[11px] font-bold text-blue-500 dark:text-blue-400 uppercase tracking-wide mb-1">
