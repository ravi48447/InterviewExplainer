    ...
    <div className={cn("inline-flex flex-col items-start gap-1.5", className)}>
      {!isSpeaking ? (
        ...
        <Button
          ...
          variant="outline"
          size="sm"
          className="font-semibold text-red-600 dark:text-red-400 border-default dark:border-default/20 hover:bg-red-50 dark:bg-red-500/10"
        >
      ...
      {error ? (
        <p className="text-[11px] font-semibold text-amber-700 dark:text-amber-400 bg-amber-50 dark:bg-amber-500/10 border border-default dark:border-default/20 rounded px-2 py-1">
          {error}
        </p>
      ) : null}
    </div>
