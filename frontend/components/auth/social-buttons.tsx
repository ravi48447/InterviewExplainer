    ...
    <div className="grid grid-cols-1 gap-2">
      {googleEnabled && (
        <a
          ...
          className="flex items-center justify-center gap-2.5 rounded-lg border border-border dark:border-border bg-background dark:bg-surface py-2.5 text-sm font-semibold text-foreground dark:text-slate-200 hover:bg-surface dark:hover:bg-slate-700 transition-colors"
        >
