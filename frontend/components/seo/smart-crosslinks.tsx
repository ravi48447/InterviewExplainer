          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-base font-black text-foreground group-hover:text-primary dark:group-hover:text-primary transition-colors leading-tight">
                ...
                <div className="mt-2 inline-flex items-center gap-1 text-[12px] font-bold text-primary dark:text-primary group-hover:gap-2 transition-all">
                  Open module
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5">
              {rest.slice(0, 3).map((m) => (
                ...
                >
                  ...
                  <div className="text-[13px] font-black text-foreground group-hover:text-primary dark:group-hover:text-primary transition-colors leading-snug line-clamp-2">
                    {m.title}
                  </div>
                </Link>
              ))}
      ...
      <div className="px-5 py-4 border-t border-border/60 bg-surface/60 space-y-2.5">
        {pillar && (
          <Link
            ...
            className="group flex items-center gap-3 px-3 py-2.5 rounded-lg bg-background border border-border hover:border-default dark:border-default hover:shadow-sm transition-all"
          >
            <Library className="h-4 w-4 text-primary dark:text-primary shrink-0" />
            <div className="flex-1 min-w-0">
              <div className="text-[11px] font-black uppercase tracking-widest text-muted-foreground leading-none mb-0.5">
                Browse the pillar
              </div>
              <div className="text-[13px] font-bold text-foreground group-hover:text-primary dark:group-hover:text-primary leading-snug truncate">
                Every {pillarTitle} module
              </div>
            </div>
            <ArrowRight className="h-4 w-4 text-muted-foreground group-hover:text-primary dark:group-hover:text-primary group-hover:translate-x-0.5 transition-all shrink-0" />
          </Link>
        )}
        ...
        >
          ...
          <ArrowRight className="h-4 w-4 text-primary dark:text-primary group-hover:translate-x-0.5 transition-all shrink-0" />
        </Link>
