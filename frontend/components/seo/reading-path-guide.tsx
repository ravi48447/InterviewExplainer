...
export function ModuleReadingPathGuide({
  ...
  return (
    <section
      ...
      className="mb-8 scroll-mt-24 rounded-2xl border border-border/90 bg-gradient-to-br from-white via-slate-50/80 to-blue-50/30 p-5 sm:p-6 shadow-sm ring-1 ring-slate-900/[0.03]"
    >
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="min-w-0 flex-1">
          ...
          <ol className="mt-4 space-y-2.5 text-sm text-foreground">
            <li className="flex gap-3">
              <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-indigo-600 text-[11px] font-bold text-primary-foreground dark:text-foreground">
                1
              </span>
            ...
            <li className="flex gap-3">
              <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-slate-200 text-[11px] font-bold text-foreground">
                2
              </span>
              <span className="pt-0.5 leading-snug">
        ...
        <div className="flex flex-col gap-2 shrink-0 w-full sm:w-auto sm:min-w-[200px]">
          <Link
            ...
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-indigo-600 px-5 py-3 text-sm font-bold text-primary-foreground dark:text-foreground shadow-md shadow-indigo-900/15 hover:bg-indigo-700 transition-colors"
          >
          ...
          <Link
            ...
            className="inline-flex items-center justify-center gap-2 rounded-xl border border-border bg-background px-4 py-2.5 text-xs font-bold text-foreground hover:border-indigo-300 hover:bg-indigo-50/60 transition-colors"
          >
          ...
          <a
            href="#all-questions"
            className="inline-flex items-center justify-center gap-2 rounded-xl border border-transparent px-4 py-2 text-xs font-semibold text-indigo-700 hover:bg-background/80 transition-colors"
          >
...
export function PillarReadingPathGuide({
  ...
  return (
    <section
      ...
      className="mb-8 scroll-mt-24 rounded-2xl border border-border/90 bg-gradient-to-br from-white via-slate-50/80 to-indigo-50/25 p-5 sm:p-6 shadow-sm ring-1 ring-slate-900/[0.03]"
    >
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-col gap-2 shrink-0 w-full lg:w-auto">
          <Link
            ...
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-indigo-600 px-5 py-3 text-sm font-bold text-primary-foreground dark:text-foreground shadow-md shadow-indigo-900/15 hover:bg-indigo-700 transition-colors whitespace-nowrap"
          >
            <BookOpenCheck className="h-4 w-4 shrink-0" aria-hidden />
