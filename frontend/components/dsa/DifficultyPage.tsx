      ...
      <div className="grid grid-cols-3 gap-3 mb-10">
        {(["easy", "medium", "hard"] as Difficulty[]).map((d) => {
          ...
          const activeClasses: Record<string, string> = {
            easy: "bg-gradient-to-br   from-emerald-50 dark:from-emerald-950/40 to-white border-emerald-200 dark:border-emerald-500/20 text-emerald-700 dark:text-emerald-400 shadow-sm",
            medium: "bg-gradient-to-br   from-amber-50 dark:from-amber-950/40 to-white border-amber-200 dark:border-amber-500/20 text-amber-700 dark:text-amber-400 shadow-sm",
            hard: "bg-gradient-to-br   from-red-50 dark:from-red-950/40 to-white border-red-200 dark:border-red-500/20 text-red-700 dark:text-red-400 shadow-sm",
          };
          return (
            <Link
              key={d}
