    ...
    <section id={id} className="scroll-mt-24 mb-12 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1.4fr_1fr] gap-6 items-start">
        ...
        {content.overview.length > 0 && (
          <div className="rounded-2xl border border-border bg-background shadow-sm overflow-hidden">
            <div className="px-6 pt-5 pb-3 border-b border-slate-100 dark:border-slate-800/60 bg-gradient-to-br from-blue-50 to-blue-50/30 dark:from-background dark:to-background/50">
        ...
        {content.studyTips.length > 0 && (
          <div className="rounded-2xl border border-violet-100 dark:border-violet-500/20 bg-background shadow-sm overflow-hidden">
            <div className="px-6 pt-5 pb-3 border-b border-violet-100 dark:border-violet-500/20 bg-gradient-to-br from-violet-50 to-violet-50/30 dark:from-background dark:to-background/50">
      ...
      {content.pitfalls.length > 0 && (
        <div className="rounded-2xl border border-rose-200 dark:border-rose-500/20 bg-background shadow-sm overflow-hidden">
          <div className="px-6 pt-5 pb-3 border-b border-rose-100 dark:border-rose-500/20 bg-gradient-to-br from-rose-50 to-rose-50/30 dark:from-background dark:to-background/50">
