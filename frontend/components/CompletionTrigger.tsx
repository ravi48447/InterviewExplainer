...
export default function CompletionTrigger({ questionId }: { questionId: number }) {
  ...
  return (
    <div className="flex items-center justify-center p-6 my-10 bg-emerald-500/10 border border-emerald-500/20 rounded-2xl text-emerald-400 gap-3 animate-in fade-in slide-in-from-bottom-4">
