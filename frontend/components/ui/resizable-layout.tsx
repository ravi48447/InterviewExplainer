...
export function ResizableLayout({
 ...
 <PanelResizeHandle className="group relative w-1.5 bg-border/40 hover:bg-primary/50 active:bg-primary/70 cursor-col-resize transition-colors z-20">
 {/* Visual highlight line */}
 <div className="absolute inset-y-0 left-1/2 w-[2px] -translate-x-1/2 bg-border/0 group-hover:bg-primary group-active:bg-primary transition-colors" />
 </PanelResizeHandle>
