  ...
  return (
    <div className="space-y-8">
      ...
      {(problemStatement || directAnswer) && (
        <div className="rounded-xl border-2 border-red-200 dark:border-red-500/20 bg-gradient-to-r from-red-50 dark:from-red-950/40 to-rose-50 dark:to-rose-950/40 overflow-hidden  ">
            ...
            {solutionSections.map((sol, i) => (
              <button
                ...
                className={`px-3 py-1 rounded text-xs font-medium transition-colors ${
                  activeSolution === i ? "bg-background shadow-sm text-blue-700 dark:text-blue-400" : "text-muted-foreground hover:text-foreground"
                }`}
              >
      ...
      {solutionSections.length === 1 && !beforeCode && (
        <div className="rounded-xl border border-emerald-200 dark:border-emerald-500/20 bg-background shadow-sm overflow-hidden">
          <div className="flex items-center gap-2 px-5 py-3 bg-emerald-50 dark:bg-emerald-500/10 border-b border-emerald-200 dark:border-emerald-500/20">
      ...
      {prevention && (
        <div className="rounded-xl border border-emerald-200 dark:border-emerald-500/20 bg-emerald-50 dark:bg-emerald-500/10 dark:bg-emerald-950/20/40 overflow-hidden">
          <div className="flex items-center gap-2 px-5 py-3 bg-emerald-100 dark:bg-emerald-950/20/50 border-b border-emerald-200 dark:border-emerald-500/20">
