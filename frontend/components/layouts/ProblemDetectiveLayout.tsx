  ...
  return (
    <div className="space-y-8">
      ...
      {(problemStatement || directAnswer) && (
        <div className="rounded-xl border-2 border-red-200 dark:border-red-500/20 bg-gradient-to-r from-red-50 to-rose-50 overflow-hidden dark:bg-none dark:bg-background">
