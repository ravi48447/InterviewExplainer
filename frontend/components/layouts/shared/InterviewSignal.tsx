...
export function InterviewSignal({ title = "Interview Signal", children }: InterviewSignalProps) {
  return (
    <div className="rounded-lg border border-violet-200 dark:border-violet-500/20 bg-gradient-to-r from-violet-50 to-purple-50 p-4 dark:bg-none dark:bg-background">
