...
function ProfileContent() {
    ...
    return (
        <main className="min-h-screen bg-surface border border-default dark:from-slate-950 py-12 px-4">
            <div className="w-full min-w-0 animate-fade-in-up">
                ...
                <div className="bg-background rounded-3xl border border-border shadow-sm p-8 md:p-12 mb-8">
                    <div className="flex flex-col md:flex-row items-center gap-8 mb-10">
                        <div className="w-24 h-24 rounded-2xl bg-surface flex items-center justify-center shadow-lg shadow-sm">
                        ...
                        <div className="text-center md:text-left">
                            ...
                            {stats?.primaryDomainName && (
                                <p className="text-sm text-primary dark:text-primary font-semibold mt-1">
                                    {stats.primaryDomainName}
                                </p>
                            )}
                        </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="p-5 rounded-2xl bg-surface border border-border text-center">
                            <Shield className="h-5 w-5 text-primary dark:text-primary mx-auto mb-2" />
                        ...
                        <div className="p-5 rounded-2xl bg-surface border border-border text-center">
                            <Target className="h-5 w-5 text-primary dark:text-primary mx-auto mb-2" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-background rounded-2xl border border-border shadow-sm p-6">
                        ...
                        {stats?.stackPerformance && stats.stackPerformance.length > 0 ? (
                            ...
                            <p className="text-sm text-muted-foreground py-4 text-center">
                                No progress yet.{" "}
                                <Link href="/domains" className="text-primary dark:text-primary font-semibold hover:underline">Start learning</Link>
                            </p>
                        )}
                    </div>
                    ...
                    <div className="bg-background rounded-2xl border border-border shadow-sm p-6">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="rounded-xl border border-default dark:border-default/20 bg-blue-50 dark:bg-blue-500/10 p-4">
                            ...
                            <Link
                                href="/domains"
                                className="block px-4 py-3 rounded-xl bg-blue-50 dark:bg-blue-500/10 border border-default dark:border-default/20 text-sm font-bold text-primary dark:text-primary hover:bg-blue-100 dark:bg-blue-950/20 transition-colors"
                            >
